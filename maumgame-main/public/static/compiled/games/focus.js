...
function NumberRound({ config, roundIndex, totalRounds, onDone }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", flex: 1, padding: "0 24px" } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    width: "100%",
    marginBottom: 24
  } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: FC.muted } }, t("\uB77C\uC6B4\uB4DC", "Round"), " ", roundIndex + 1, " / ", totalRounds), /* @__PURE__ */ React.createElement("div", { style: {
    ...
    padding: "3px 12px",
    borderRadius: 100
  } }, "\u{1F522} ", t("\uC22B\uC790 \uAE30\uC5B5", "Number Memory"))), phase === "breathe" && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 } }, /* @__PURE__ */ React.createElement("div", { style: {
    width: 100,
    height: 100,
    borderRadius: "50%",
  ...
  } }, breathCount > 0 ? breathCount : "\u{1F33F}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 600, color: FC.dark } }, t("\uC7A0\uAE50 \uB9C8\uC74C\uC744 \uAC00\uB2E4\uB4EC\uC5B4\uC694", "Take a moment to settle your mind")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.muted, textAlign: "center", lineHeight: 1.7 } }, t("\uC22B\uC790\uAC00 \uD558\uB098\uC529 \uB098\uD0C0\uB0A0 \uAC70\uC608\uC694", "Numbers will appear one by one"), /* @__PURE__ */ React.createElement("br", null), t("\uC21C\uC11C\uB300\uB85C \uAE30\uC5B5\uD574 \uB450\uC138\uC694", "Remember them in order")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.sky, fontWeight: 700 } }, t(`${config.span}\uC790\uB9AC \uC22B\uC790\uB97C \uAE30\uC5B5\uD558\uC138\uC694`, `Memorize the ${config.span}-digit number`))), phase === "show" && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 } }, /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 13,
    fontWeight: 600,
    color: FC.muted,
    display: "flex",
  ...
  } }, numbers[currentIdx]) : /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, animation: "pulse 0.5s ease" } }, "\u2713")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.muted } }, currentIdx < numbers.length ? `${currentIdx + 1} / ${numbers.length}` : t("\uC774\uC81C \uC785\uB825\uD558\uC138\uC694!", "Now enter the numbers!"))), phase === "input" && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, width: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark } }, t("\uAE30\uC5B5\uD55C \uC22B\uC790\uB97C \uC21C\uC11C\uB300\uB85C \uC785\uB825\uD558\uC138\uC694", "Enter the numbers in order")), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    gap: 10,
    justifyContent: "center",
    flexWrap: "wrap",
    ...
    borderRadius: 16,
    padding: "14px 20px"
  } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: FC.muted, marginBottom: 4 } }, t("\uC785\uB825", "Input")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 5 } }, input.map((d, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    width: 34,
    height: 34,
    borderRadius: 8,
    ...
    fontWeight: 700,
    fontFamily: "monospace"
  } }, d))))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.muted } }, t("\uC815\uB2F5", "Answer"), ": ", numbers.join(" - ")), /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 16,
    fontWeight: 700,
    color: result.perfect ? FC.amber : FC.sage
  } }, "+", result.score, t("\uC810", "pts")), /* @__PURE__ */ React.createElement("button", { onClick: () => onDone(result.score), style: {
...
function GridRound({ config, roundIndex, totalRounds, onDone }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", flex: 1, padding: "0 24px" } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    padding: "3px 12px",
    borderRadius: 100
  } }, "\u{1F7E2} ", t("\uD328\uD134 \uAE30\uC5B5", "Pattern Memory"))), phase === "show" && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark, textAlign: "center" } }, showCountdown > 0 ? t(`${showCountdown}\uCD08 \uD6C4 \uD328\uD134\uC774 \uC0AC\uB77C\uC838\uC694`, `Pattern disappears in ${showCountdown}s`) : t("\uD328\uD134\uC744 \uAE30\uC5B5\uD558\uC138\uC694!", "Memorize the pattern!")), /* @__PURE__ */ React.createElement("div", { style: {
    display: "grid",
    ...
    transition: "all 0.3s"
  } }))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.muted } }, t(`${config.lights}\uAC1C \uCE78\uC758 \uC704\uCE58\uB97C \uAE30\uC5B5\uD558\uC138\uC694`, `Remember the position of ${config.lights} cells`))), phase === "input" && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark } }, t("\uAE30\uC5B5\uD55C \uCE78\uC744 \uB20C\uB7EC\uBCF4\uC138\uC694", "Tap the cells you remember")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: FC.muted } }, "(", selected.size, " / ", config.lights, t("\uAC1C \uC120\uD0DD\uB428", " selected"), ")"), /* @__PURE__ */ React.createElement("div", { style: {
    display: "grid",
    gridTemplateColumns: `repeat(${config.size}, ${cellSize}px)`,
    gap
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, fontSize: 11 } }, /* @__PURE__ */ React.createElement("span", { style: { color: FC.sage } }, "\u25A0 ", t("\uC815\uB2F5", "Correct")), /* @__PURE__ */ React.createElement("span", { style: { color: FC.amber } }, "\u25A0 ", t("\uB193\uCE68", "Missed")), /* @__PURE__ */ React.createElement("span", { style: { color: FC.warn } }, "\u25A0 ", t("\uC624\uB2F5", "Wrong"))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: result.perfect ? FC.amber : FC.sage } }, "+", result.score, t("\uC810", "pts")), /* @__PURE__ */ React.createElement("button", { onClick: () => onDone(result.score), style: {
    fontFamily: "'Noto Sans KR',sans-serif",
    background: `linear-gradient(135deg, ${FC.sage}, ${FC.sageL})`,
    color: "white",
    border: "none",
...
function FocusGame({ onExit }) {
  ...
  if (screen === "intro") return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    padding: "4px 8px",
    color: FC.muted
  } }, "\u2190"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: FC.dark } }, t("\uB9C8\uC74C \uC9D1\uC911\uB825", "Mind Focus")), personalBest !== null && /* @__PURE__ */ React.createElement("div", { style: {
    marginLeft: "auto",
    fontSize: 11,
    fontWeight: 700,
    ...
    padding: "3px 10px",
    borderRadius: 100
  } }, t("\uCD5C\uACE0", "Best"), " ", personalBest, t("\uC810", "pts"))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 32 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 72, marginBottom: 16, animation: "float 3s ease-in-out infinite" } }, "\u{1F9E0}"), /* @__PURE__ */ React.createElement("h1", { style: {
    fontSize: 26,
    fontWeight: 700,
    color: FC.dark,
    marginBottom: 10,
    ...
    lineHeight: 1.4
  } }, t("\uB9C8\uC74C \uC9D1\uC911\uB825 \uD6C8\uB828", "Mind Focus Training")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 14, color: FC.muted, lineHeight: 1.8 } }, t("\uC22B\uC790 \uAE30\uC5B5\uACFC \uD328\uD134 \uCC3E\uAE30\uB85C", "Practice focusing on the present moment"), /* @__PURE__ */ React.createElement("br", null), t("\uC9C0\uAE08 \uC774 \uC21C\uAC04\uC5D0 \uC9D1\uC911\uD558\uB294 \uC5F0\uC2B5\uC744 \uD574\uC694", "with number memory and pattern recall"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12, marginBottom: 28 } }, [
    ...
    textAlign: "center"
  } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: FC.indigo, fontWeight: 600 } }, t(`\uCD1D ${totalRounds}\uB77C\uC6B4\uB4DC \xB7 \uC22B\uC790 \uAE30\uC5B5 + \uD328\uD134 \uAE30\uC5B5 \uAD50\uCC28 \uC9C4\uD589`, `${totalRounds} rounds total \xB7 Number Memory + Pattern Memory alternating`))), /* @__PURE__ */ React.createElement("button", { onClick: handleStart, style: {
    fontFamily: "'Noto Sans KR',sans-serif",
  ...
  if (screen === "playing") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      fontSize: 11,
      cursor: "pointer"
    } }, t("\uD5C8\uBE0C\uB85C", "Hub"), " \u2192")), /* @__PURE__ */ React.createElement("div", { style: { height: 5, background: "rgba(0,0,0,0.07)", borderRadius: 10, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: {
      height: "100%",
      borderRadius: 10,
  ...
  if (screen === "done") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    } }, "\u{1F3C6} ", t("\uC2E0\uAE30\uB85D!", "New Record!"))), /* @__PURE__ */ React.createElement("div", { style: {
    ...
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: FC.muted, marginBottom: 10 } }, t("\uB77C\uC6B4\uB4DC\uBCC4 \uC810\uC218", "Score per Round")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, scores.map((s, i) => {
      const r = rounds[i];
      ...
      } })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: FC.dark, width: 40, textAlign: "right" } }, s, t("\uC810", "pts")));
      ...
      fontWeight: 600,
      cursor: "pointer"
    } }, t("\uD5C8\uBE0C\uB85C", "Hub"), " \u2192"), /* @__PURE__ */ React.createElement("button", { onClick: handleSave, disabled: isSaving, style: {
      fontFamily: "'Noto Sans KR',sans-serif",
      flex: 2,
      padding: "14px",
      borderRadius: 14,
    ...
    } }, isSaving ? t("\uC800\uC7A5 \uC911...", "Saving...") : t("\u2713 \uC800\uC7A5\uD558\uACE0 \uB098\uAC00\uAE30", "\u2713 Claim EXP"))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      const text = t(
        `\u{1F9E0} \uB9C8\uC74C \uC9D1\uC911\uB825 \uD6C8\uB828
