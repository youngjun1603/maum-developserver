...
function TestBadgeRow({ completedTests = [] }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 600, color: C.muted, marginBottom: 10, letterSpacing: "0.5px" }, children: t("\uC5F0\uACB0\uB41C \uC2EC\uB9AC\uAC80\uC0AC", "Linked Tests") }),
    /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 7 }, children: allTests.map((t2) => {
    ...
    completedTests.length === 0 && /* @__PURE__ */ jsxs("div", { style: { marginTop: 10, fontSize: 12, color: C.muted, lineHeight: 1.6 }, children: [
      ...
      " ",
      /* @__PURE__ */ jsx("a", { href: PHYWEB_URL, style: { color: C.sage, fontWeight: 600, textDecoration: "none" }, children: t("\uB9C8\uC74C\uD480\uC5D0\uC11C \uAC80\uC0AC\uD558\uAE30 \u2192", "Take a test at Maumful \u2192") })
    ] })
  ] });
}
    ...
    "div",
    {
      ...
      children: [
        comingSoon && /* @__PURE__ */ jsx("div", { style: {
          ...
          borderRadius: 100,
          letterSpacing: "0.5px"
        }, children: t("\uC900\uBE44 \uC911", "Coming Soon") }),
        !comingSoon && !game.isUnlocked && /* @__PURE__ */ jsx("div", { style: {
          position: "absolute",
          top: 12,
          right: 12,
          background: C.sand,
          ...
          padding: "3px 9px",
          borderRadius: 100
        }, children: t(`Lv.${game.unlockLevel} \uD574\uAE08`, `Lv.${game.unlockLevel} Unlock`) }),
        ...
        }, children: game.creditCost > 0 ? `\u{1F33F} ${game.creditCost} ${t("\uD06C\uB808\uB527", "Credits")}` : t("\uBB34\uB8CC", "Free") }),
        game.requiredTests.length > 0 && /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: C.dusty, marginBottom: 12 }, children: [
          game.requiredTests.map((t2) => TEST_META_HUB[t2]?.label || t2).join(" \xB7 "),
          " ",
          t("\uC5F0\uB3D9", "linked")
        ] }),
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: comingSoon ? t("\uACE7 \uCD9C\uC2DC\uB429\uB2C8\uB2E4", "Coming Soon") : locked ? `\u{1F512} ${t("\uC7A0\uAE08 \uD574\uC81C \uD544\uC694", "Locked")}` : t("\uC2DC\uC791\uD558\uAE30 \u2192", "Start \u2192")
          }
        )
      ]
    }
  ...
  return /* @__PURE__ */ jsxs("div", { style: { padding: "16px 20px", background: "rgba(255,255,255,0.7)", borderRadius: 16, backdropFilter: "blur(8px)" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }, children: [
      ...
      streakDays > 0 && /* @__PURE__ */ jsxs("div", { style: { fontSize: 12, fontWeight: 700, color: C.amber, display: "flex", alignItems: "center", gap: 4 }, children: [
        fireEmoji,
        " ",
        t(`${streakDays}\uC77C \uC5F0\uC18D`, `${streakDays}-Day Streak`)
      ] })
    ] }),
    ...
    nextMilestone && /* @__PURE__ */ jsxs("div", { style: { marginBottom: streakRecover > 0 && streakDays === 0 ? 10 : 0 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 10, color: C.muted, marginBottom: 4 }, children: [
        /* @__PURE__ */ jsxs("span", { children: [
          t("\uB2E4\uC74C \uBAA9\uD45C", "Next Goal"),
          ": ",
          t(`${nextMilestone}\uC77C \uC5F0\uC18D \u{1F3C5}`, `${nextMilestone}-Day Streak \u{1F3C5}`)
        ] }),
        /* @__PURE__ */ jsxs("span", { children: [
          streakDays,
          " / ",
          t(`${nextMilestone}\uC77C`, `${nextMilestone} days`)
        ] })
      ] }),
    ...
    streakRecover > 0 && streakDays === 0 && /* @__PURE__ */ jsx("button", { onClick: handleRecover, disabled: recovering, style: {
      ...
      fontFamily: "'Noto Sans KR',sans-serif"
    }, children: recovering ? t("\uBCF5\uAD6C \uC911...", "Restoring...") : `\u{1F6E1}\uFE0F ${t("\uBCF5\uAD6C\uAD8C \uC0AC\uC6A9\uD558\uC5EC \uC2A4\uD2B8\uB9AD \uBCF5\uC6D0", "Use Recovery Pass")} (${t(`${streakRecover}\uAC1C \uBCF4\uC720`, `${streakRecover} held`)})` }),
    streakRecover > 0 && streakDays > 0 && /* @__PURE__ */ jsxs("div", { style: { marginTop: 8, fontSize: 10, color: C.amber, fontWeight: 600, textAlign: "right" }, children: [
      "\u{1F6E1}\uFE0F ",
      t(`\uBCF5\uAD6C\uAD8C ${streakRecover}\uAC1C \uBCF4\uC720`, `${streakRecover} Recovery Pass(es) held`),
      " (",
      t("\uC5F0\uC18D \uB04A\uAE38 \uB54C \uC790\uB3D9 \uC0AC\uC6A9 \uAC00\uB2A5", "auto-used when streak breaks"),
      ")"
    ] })
  ] });
}
function DailyTip({ hubData }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { fontSize: 10, fontWeight: 700, color: C.sage, marginBottom: 5, letterSpacing: "0.5px" }, children: [
      "\u{1F916} ",
...
function Leaderboard({ currentUserEmail }) {
  ...
  if (loading) return /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: "20px 0" }, children: /* @__PURE__ */ jsx("div", { style: { fontSize: 13, color: C.muted, animation: "pulse 1.5s infinite" }, children: t("\uC21C\uC704\uB97C \uBD88\uB7EC\uC624\uB294 \uC911...", "Loading rankings...") }) });
  if (!data?.length) return /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: "20px 0", color: C.muted, fontSize: 13 }, children: t("\uC544\uC9C1 \uC21C\uC704 \uB370\uC774\uD130\uAC00 \uC5C6\uC5B4\uC694", "No ranking data yet") });
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, fontWeight: 700, color: C.dark, display: "flex", alignItems: "center", gap: 5 }, children: [
          ...
          isMe && /* @__PURE__ */ jsx("span", { style: { fontSize: 10, background: C.sage, color: "white", borderRadius: 4, padding: "1px 5px" }, children: t("\uB098", "Me") })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: C.muted }, children: [
          "Lv.",
          entry.garden_level,
          " ",
          levelInfo.name,
          (entry.streak_days || 0) > 1 && ` \xB7 \u{1F525} ${t(`${entry.streak_days}\uC77C`, `${entry.streak_days}d`)}`
        ] })
      ] }),
...
function LoginGate() {
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx("h1", { style: { fontSize: 28, fontWeight: 700, color: C.dark, marginBottom: 10, fontFamily: "'Noto Serif KR', serif" }, children: t("\uB9C8\uC74C\uC758 \uC815\uC6D0", "Mind Garden") }),
    /* @__PURE__ */ jsx("p", { style: { fontSize: 15, color: C.muted, lineHeight: 1.8, marginBottom: 32, maxWidth: 300 }, children: t(
      ...
      /* @__PURE__ */ jsxs(Fragment, { children: [
        "Log in to Maumful",
        /* @__PURE__ */ jsx("br", {}),
        "and enjoy without a separate login.",
        /* @__PURE__ */ jsx("br", {}),
        "Connect your psych test results",
        /* @__PURE__ */ jsx("br", {}),
        "and grow your own garden \u{1F33F}"
      ] })
    ) }),
    /* @__PURE__ */ jsx("a", { href: PHYWEB_URL, style: {
      ...
      fontFamily: "'Noto Sans KR', sans-serif"
    }, children: t("\uB9C8\uC74C\uD480 \uB85C\uADF8\uC778\uD558\uACE0 \uC2DC\uC791\uD558\uAE30 \u2192", "Log in to Maumful to start \u2192") })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs("div", { style: { marginBottom: 24 }, children: [
    /* @__PURE__ */ jsxs("button", { onClick: handleToggle, style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 14, fontWeight: 700, color: C.dark }, children: t("\uC2A4\uD1A0\uB9AC \uCEA0\uD398\uC778", "Story Campaign") }),
      ...
      /* @__PURE__ */ jsx("span", { style: { fontSize: 12, color: C.muted }, children: expanded ? t("\uC811\uAE30 \u25B2", "Collapse \u25B2") : t("\uD3BC\uCE58\uAE30 \u25BC", "Expand \u25BC") })
    ] }),
    expanded && /* @__PURE__ */ jsxs("div", { style: {
      ...
      loading && /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: "24px", color: C.muted, fontSize: 13 }, children: t("\uBD88\uB7EC\uC624\uB294 \uC911...", "Loading...") }),
      claimResult && /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: C.amber }, children: t("\uCC55\uD130 \uBCF4\uC0C1 \uC218\uB839 \uC644\uB8CC!", "Chapter reward claimed!") }),
          /* @__PURE__ */ jsxs("div", { style: { fontSize: 12, color: C.muted }, children: [
            "+",
            claimResult.credits,
            " ",
            t("\uD06C\uB808\uB527\uC774 \uC9C0\uAE09\uB410\uC5B4\uC694", "credits have been sent.")
          ] })
        ] }),
        ...
        return /* @__PURE__ */ jsxs("div", { style: {
          ...
          !locked && /* @__PURE__ */ jsxs("div", { style: { padding: "10px 16px", display: "flex", flexDirection: "column", gap: 7 }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { style: { fontSize: 11, fontWeight: 700, color: rewarded ? ch.color : canClaim ? C.amber : C.muted }, children: rewarded ? `\u2705 ${ch.rewardBadge} ${ch.rewardName} ${t("\uD68D\uB4DD!", "Earned!")}` : `\u{1F381} ${t("\uCC55\uD130 \uC644\uB8CC \uBCF4\uC0C1", "Chapter Reward")}: +${ch.rewardCredits} ${t("\uD06C\uB808\uB527", "Credits")} \xB7 ${ch.rewardBadge} ${ch.rewardName}` }),
                rewarded && /* @__PURE__ */ jsx("div", { style: { fontSize: 10, color: C.muted, marginTop: 2 }, children: t("\uBCF4\uC0C1\uC774 \uC9C0\uAE09\uB410\uC5B4\uC694", "Reward has been sent.") })
              ] }),
              canClaim && /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: claiming === ch.id ? "..." : `${t("\uBCF4\uC0C1 \uBC1B\uAE30", "Claim Reward")} \u{1F381}`
                }
              )
            ] })
          ] }),
          locked && /* @__PURE__ */ jsx("div", { style: { padding: "10px 16px 14px", textAlign: "center", fontSize: 12, color: C.muted }, children: t("\uC774\uC804 \uCC55\uD130\uB97C \uC644\uB8CC\uD558\uBA74 \uD574\uAE08\uB3FC\uC694", "Complete the previous chapter to unlock.") })
        ] }, ch.id);
      }) })
    ] })
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { style: { marginBottom: 24 }, children: [
    ...
    expanded && /* @__PURE__ */ jsxs("div", { style: {
      ...
      !loading && stats && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: C.muted, marginBottom: 10, letterSpacing: "0.5px" }, children: t("\uAC8C\uC784\uBCC4 \uC218\uD589 \uD604\uD669", "Performance by Game") }),
        perGame.length === 0 && /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: "20px", color: C.muted, fontSize: 13 }, children: t("\uC544\uC9C1 \uD50C\uB808\uC774 \uAE30\uB85D\uC774 \uC5C6\uC5B4\uC694", "No play records yet") }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 7 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: C.dark }, children: t("\uC5C5\uC801", "Achievements") }),
    ...
    sorted.length > 6 && /* @__PURE__ */ jsx("button", { onClick: () => setExpanded((v) => !v), style: {
      ...
      fontFamily: "'Noto Sans KR',sans-serif",
      padding: "2px 0"
    }, children: expanded ? t("\uC811\uAE30 \u25B2", "Collapse \u25B2") : t(`+${sorted.length - 6}\uAC1C \uB354\uBCF4\uAE30 \u25BC`, `+${sorted.length - 6} more \u25BC`) })
  ] });
}
function AchievementToast({ achievements = [], onDismiss }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: C.dark }, children: t("\uC5C5\uC801 \uB2EC\uC131!", "Achievement Unlocked!") }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 7 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: C.dark }, children: t("\uBC88\uC544\uC6C3 \uC9C0\uC218 \uCD94\uC774", "BURNOUT Score Trend") }),
        /* @__PURE__ */ jsxs("span", { style: {
          fontSize: 11,
          fontWeight: 700,
          background: level.bg,
      ...
      /* @__PURE__ */ jsx("button", { onClick: handleToggle, style: {
        ...
        fontWeight: 600,
        fontFamily: "'Noto Sans KR',sans-serif"
      }, children: expanded ? t("\uC811\uAE30 \u25B2", "Collapse \u25B2") : t("\uD3BC\uCE58\uAE30 \u25BC", "Expand \u25BC") })
    ] }),
    expanded && /* @__PURE__ */ jsxs("div", { style: { marginTop: 14, animation: "fadeUp 0.3s ease" }, children: [
      loading && /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: 16, color: C.muted, fontSize: 12 }, children: t("\uBD88\uB7EC\uC624\uB294 \uC911...", "Loading...") }),
      !loading && history && entries.length === 0 && /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", padding: 16, color: C.muted, fontSize: 12 }, children: [
        t("\uC544\uC9C1 \uBC88\uC544\uC6C3 \uAC8C\uC784 \uAE30\uB85D\uC774 \uC5C6\uC5B4\uC694.", "No BURNOUT game records yet."),
        /* @__PURE__ */ jsx("br", {}),
        t("\uAC8C\uC784\uC744 \uD50C\uB808\uC774\uD558\uBA74 \uC810\uC218 \uBCC0\uD654\uB97C \uD655\uC778\uD560 \uC218 \uC788\uC5B4\uC694!", "Play the game to track score changes!")
      ] }),
      !loading && entries.length >= 2 && /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: C.muted, marginBottom: 8 }, children: t("\uBC88\uC544\uC6C3 \uC810\uC218 \uC774\uB825 (\uB0AE\uC744\uC218\uB85D \uAC74\uAC15)", "BURNOUT score history (lower is healthier)") }),
        /* @__PURE__ */ jsxs("svg", { viewBox: `0 0 ${W} ${H}`, style: { width: "100%", height: "auto", display: "block" }, children: [
          ...
          pts.map((p, i) => /* @__PURE__ */ jsxs("g", { children: [
            ...
            /* @__PURE__ */ jsx("text", { x: p.x, y: H - 1, textAnchor: "middle", fontSize: "7", fill: "#C0C0C0", children: (/* @__PURE__ */ new Date(p.date + "T00:00:00")).toLocaleDateString(GAME_LANG === "en" ? "en-US" : "ko-KR", { month: "numeric", day: "numeric" }) })
          ] }, i)),
          /* @__PURE__ */ jsx(
            "text",
            {
        ...
        pts.length >= 2 && (() => {
          ...
          }, children: diff <= 0 ? t(`\u2705 \uC9C0\uB09C \uD68C \uB300\uBE44 ${Math.abs(diff)}\uC810 \uAC1C\uC120\uB410\uC5B4\uC694!`, `\u2705 Improved by ${Math.abs(diff)}pts from last time!`) : t(`\u26A0\uFE0F \uC9C0\uB09C \uD68C \uB300\uBE44 ${diff}\uC810 \uB192\uC544\uC84C\uC5B4\uC694. \uC26C\uC5B4\uAC00\uC138\uC694.`, `\u26A0\uFE0F Up by ${diff}pts from last time. Take a break.`) });
        })()
      ] }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: { background: "rgba(255,255,255,0.7)", backdropFilter: "blur(8px)", borderRadius: 20, padding: "16px 20px", marginBottom: 24, border: "1px solid rgba(255,255,255,0.6)" }, children: [
    /* @__PURE__ */ jsxs("button", { onClick: handleToggle, style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", background: "none", border: "none", cursor: "pointer", fontFamily: "'Noto Sans KR',sans-serif" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { fontSize: 14, fontWeight: 700, color: C.dark, display: "flex", alignItems: "center", gap: 6 }, children: [
        ...
        " ",
        t("\uAC8C\uC784 \uD50C\uB808\uC774 \uC774\uB825", "Game Play History")
      ] }),
      /* @__PURE__ */ jsx("span", { style: { fontSize: 12, color: C.muted }, children: expanded ? t("\uC811\uAE30 \u25B2", "Collapse \u25B2") : t("\uD3BC\uCE58\uAE30 \u25BC", "Expand \u25BC") })
    ] }),
    expanded && /* @__PURE__ */ jsxs("div", { style: { marginTop: 14 }, children: [
      loading && /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: 16, color: C.muted, fontSize: 12 }, children: t("\uBD88\uB7EC\uC624\uB294 \uC911...", "Loading...") }),
      !loading && sessions && sessions.length === 0 && /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: 16, color: C.muted, fontSize: 12 }, children: t("\uC544\uC9C1 \uD50C\uB808\uC774 \uAE30\uB85D\uC774 \uC5C6\uC5B4\uC694", "No play records yet") }),
    ...
    return /* @__PURE__ */ jsxs("div", { style: { background: "white", borderRadius: 16, padding: "16px 18px", marginBottom: 12, border: "1px solid rgba(0,0,0,.08)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          ...
          /* @__PURE__ */ jsx("span", { style: { fontSize: 14, fontWeight: 700, color: "#2D6A4F" }, children: t("\uC624\uB298\uC758 \uB9C8\uC74C \uC77C\uAE30", "Today's Mind Diary") })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: loading ? t("\uC0DD\uC131 \uC911...", "Generating...") : t("\u270D\uFE0F \uC77C\uAE30 \uC0DD\uC131", "\u270D\uFE0F Generate Diary")
          }
        )
      ] }),
      /* @__PURE__ */ jsx("p", { style: { fontSize: 12, color: "#9A9A9A", margin: 0 }, children: t("\uC624\uB298\uC758 \uAC10\uC815 \uAE30\uB85D\uC744 \uBC14\uD0D5\uC73C\uB85C AI\uAC00 \uB9C8\uC74C \uC77C\uAE30\uB97C \uC791\uC131\uD574 \uB4DC\uB824\uC694.", "AI writes a mind diary based on your emotion records today.") })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { style: { background: "linear-gradient(135deg,#f0fdf4,#dcfce7)", borderRadius: 16, padding: "16px 18px", marginBottom: 12, border: "1px solid #bbf7d0" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ jsx("span", { style: { fontSize: 18 }, children: "\u{1F4D4}" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("span", { style: { fontSize: 14, fontWeight: 700, color: "#15803d" }, children: t("\uC624\uB298\uC758 \uB9C8\uC74C \uC77C\uAE30", "Today's Mind Diary") }),
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: t("\uACF5\uC720 \u{1F517}", "Share \u{1F517}")
        }
      )
    ] }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, fontWeight: 700, color: C.dark, display: "flex", alignItems: "center", gap: 6 }, children: [
        dominantEmoji,
        " ",
        t("\uC774\uBC88 \uC8FC \uAC10\uC815 \uD750\uB984", "This Week's Mood Flow")
      ] }),
      /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: C.muted }, children: t(`${entries.length}\uC77C \uAE30\uB85D`, `${entries.length} days recorded`) })
    ] }),
    ...
    dominant && /* @__PURE__ */ jsxs("div", { style: { fontSize: 12, color: C.muted, marginTop: 10, textAlign: "center" }, children: [
      t("\uC774\uBC88 \uC8FC \uC8FC\uC694 \uAC10\uC815", "This week's dominant mood"),
      ":",
      " ",
      /* @__PURE__ */ jsxs("span", { style: { color: C.dark, fontWeight: 600 }, children: [
        dominantEmoji,
        " ",
        dominant[0] === "happy" ? t("\uD589\uBCF5", "Happy") : dominant[0] === "calm" ? t("\uD3C9\uC628", "Calm") : dominant[0] === "tired" ? t("\uD53C\uACE4", "Tired") : dominant[0] === "anxious" ? t("\uBD88\uC548", "Anxious") : dominant[0] === "sad" ? t("\uC2AC\uD514", "Sad") : dominant[0]
      ] }),
      " ",
      "(",
...
function EmotionWeeklyReport() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 7 }, children: [
        /* @__PURE__ */ jsx("span", { style: { fontSize: 16 }, children: "\u{1F4CA}" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: C.dark }, children: t("\uC774\uBC88 \uC8FC \uAC10\uC815 \uD750\uB984", "This Week's Mood Flow") }),
        entries.length > 0 && /* @__PURE__ */ jsx("span", { style: {
          fontSize: 11,
          fontWeight: 600,
          background: C.sagePale,
          color: C.sage,
          borderRadius: 100,
          padding: "2px 8px"
        }, children: t(`${entries.length}\uC77C \uAE30\uB85D`, `${entries.length} days recorded`) })
      ] }),
    ...
    expanded && /* @__PURE__ */ jsxs("div", { style: { marginTop: 14, animation: "fadeUp 0.3s ease" }, children: [
      entries.length > 0 && /* @__PURE__ */ jsx("div", { style: {
        ...
        return /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 9, color: C.muted, textAlign: "center" }, children: (/* @__PURE__ */ new Date(e.date + "T00:00:00")).toLocaleDateString(GAME_LANG === "en" ? "en-US" : "ko-KR", { month: "numeric", day: "numeric" }) }),
          /* @__PURE__ */ jsx("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 10, fontWeight: 700, color: C.sage, marginBottom: 6, letterSpacing: "0.5px" }, children: [
          "\u{1F916} ",
        ...
        reportData.cached && /* @__PURE__ */ jsx("div", { style: { fontSize: 10, color: C.muted, marginTop: 6 }, children: t("\uC774\uBC88 \uC8FC \uBD84\uC11D \xB7 \uB9E4\uC8FC \uC6D4\uC694\uC77C \uAC31\uC2E0", "This week's analysis \xB7 Updated every Monday") })
      ] })
    ] })
  ] });
}
...
function TodayRecommendCard({ hubData, onPlay }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { fontSize: 10, fontWeight: 700, color: rec.color, marginBottom: 10, letterSpacing: "0.5px" }, children: [
      "\u2728 ",
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 7 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: C.dark }, children: t("\uC624\uB298\uC758 \uD018\uC2A4\uD2B8", "Today's Quests") }),
        /* @__PURE__ */ jsxs("span", { style: {
          fontSize: 11,
          fontWeight: 700,
...
function OnboardingOverlay({ onDone }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    /* @__PURE__ */ jsx("button", { onClick: handleNext, style: {
      ...
      cursor: "pointer",
      boxShadow: `0 8px 24px ${C.sage}44`
    }, children: isLast ? t("\u{1F33F} \uC815\uC6D0 \uD0D0\uD5D8 \uC2DC\uC791\uD558\uAE30", "\u{1F33F} Start Exploring") : t("\uB2E4\uC74C \u2192", "Next \u2192") }),
...
function GameHubApp() {
  ...
  if (error) return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx("a", { href: PHYWEB_URL, style: {
      ...
      textDecoration: "none",
      fontFamily: "'Noto Sans KR', sans-serif"
    }, children: t("\uB9C8\uC74C\uD480\uC73C\uB85C \uB3CC\uC544\uAC00\uAE30", "Back to Maumful") })
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { style: { minHeight: "100vh", background: `linear-gradient(160deg, ${C.sagePale} 0%, ${C.cream} 40%, #EBF4FA 100%)` }, children: [
    counselingPrompt && /* @__PURE__ */ jsx("div", { style: {
      position: "fixed",
      inset: 0,
      ...
      zIndex: 3e3,
      padding: 20
    }, onClick: () => setCounselingPrompt(null), children: /* @__PURE__ */ jsxs("div", { style: {
      background: "white",
      borderRadius: 20,
      padding: 28,
      maxWidth: 340,
      ...
      /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 16 }, children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: 48, marginBottom: 8 }, children: counselingPrompt.emoji }),
        /* @__PURE__ */ jsx("div", { style: {
          display: "inline-block",
          fontSize: 12,
          fontWeight: 700,
          ...
          padding: "3px 12px",
          marginBottom: 12
        }, children: counselingPrompt.level }),
        /* @__PURE__ */ jsx("p", { style: { fontSize: 15, color: "#1A1A1A", lineHeight: 1.6, margin: 0 }, children: counselingPrompt.msg })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: t("\uAD1C\uCC2E\uC544\uC694, \uACC4\uC18D \uAC8C\uC784\uD560\uAC8C\uC694", "I'm fine, continue playing")
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("nav", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 16, fontWeight: 700, color: C.dark, fontFamily: "'Noto Serif KR', serif" }, children: t("\uB9C8\uC74C\uC758 \uC815\uC6D0", "Mind Garden") })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
        /* @__PURE__ */ jsxs("div", { style: {
          fontSize: 12,
        ...
        /* @__PURE__ */ jsxs("a", { href: PHYWEB_URL, style: {
          fontSize: 12,
          color: C.muted,
          textDecoration: "none",
          padding: "5px 12px",
        ...
        /* @__PURE__ */ jsxs("div", { style: { padding: "16px 20px 20px", display: "flex", flexDirection: "column", gap: 12 }, children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { style: { fontSize: 18, fontWeight: 700, color: C.dark, marginBottom: 4 }, children: [
              t(`\uC548\uB155\uD558\uC138\uC694, ${user?.nickname || user?.email?.split("@")[0]}\uB2D8 \u{1F44B}`, `Hello, ${user?.nickname || user?.email?.split("@")[0]} \u{1F44B}`),
              isMaster && /* @__PURE__ */ jsx("span", { style: { fontSize: 11, background: "#2D6A4F", color: "white", borderRadius: 6, padding: "2px 8px", fontWeight: 700, marginLeft: 6 }, children: "MASTER" })
            ] }),
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { style: { fontSize: 14, fontWeight: 700, color: C.dark, display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                " ",
                t("\uC815\uC6D0\uC0AC \uC21C\uC704", "Gardener Rankings")
              ] }),
              /* @__PURE__ */ jsx("span", { style: { fontSize: 12, color: C.muted }, children: showLeaderboard ? t("\uC811\uAE30 \u25B2", "Collapse \u25B2") : t("\uD3BC\uCE58\uAE30 \u25BC", "Expand \u25BC") })
            ]
          }
        ),
    ...
    creditModal && /* @__PURE__ */ jsx("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 20 }, children: [
        ...
        /* @__PURE__ */ jsx("p", { style: { fontSize: 13, color: "#8A8A78", lineHeight: 1.6 }, children: t("\uC774 \uAC8C\uC784\uC740 \uD50C\uB808\uC774 \uC2DC \uD06C\uB808\uB527\uC774 \uCC28\uAC10\uB429\uB2C8\uB2E4", "Credits will be deducted to play this game") })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: {
        background: "#F5EFE0",
        borderRadius: 14,
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 6, fontSize: 13 }, children: [
          /* @__PURE__ */ jsx("span", { style: { color: "#8A8A78" }, children: t("\uD604\uC7AC \uD06C\uB808\uB527", "Current Credits") }),
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 13 }, children: [
          /* @__PURE__ */ jsx("span", { style: { color: "#8A8A78" }, children: t("\uCC28\uAC10 \uC608\uC815", "To be deducted") }),
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 14 }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontWeight: 700, color: "#2C2C20" }, children: t("\uCC28\uAC10 \uD6C4 \uC794\uC561", "Balance after") }),
          /* @__PURE__ */ jsxs("span", { style: {
            fontWeight: 700,
      ...
      (creditModal.insufficient || creditModal.balance < creditModal.cost) && /* @__PURE__ */ jsx("div", { style: {
        ...
        color: "#C05050",
        lineHeight: 1.6
      }, children: t("\uD06C\uB808\uB527\uC774 \uBD80\uC871\uD574\uC694. \uB9C8\uC74C\uD480\uC5D0\uC11C \uD06C\uB808\uB527\uC744 \uCDA9\uC804\uD55C \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574\uC8FC\uC138\uC694.", "Insufficient credits. Please recharge on Maumful and try again.") }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 10 }, children: [
        ...
        creditModal.balance < creditModal.cost ? /* @__PURE__ */ jsx("a", { href: PHYWEB_URL, style: {
          ...
          justifyContent: "center",
          fontFamily: "'Noto Sans KR',sans-serif"
        }, children: t("\uD06C\uB808\uB527 \uCDA9\uC804\uD558\uAE30 \u2192", "Recharge Credits \u2192") }) : /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: spendLoading ? t("\uCC98\uB9AC \uC911...", "Processing...") : t(`${creditModal.cost} \uD06C\uB808\uB527\uC73C\uB85C \uC2DC\uC791`, `Start with ${creditModal.cost} Credits`)
          }
        )
      ] })
    ] }) }),
    ...
    sessionFeedback && /* @__PURE__ */ jsx("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: C.sage, marginBottom: 4 }, children: t("\uAC8C\uC784 \uC644\uB8CC! \u{1F389}", "Game Complete! \u{1F389}") }),
