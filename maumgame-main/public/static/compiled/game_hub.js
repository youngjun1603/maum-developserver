...
function GameHubApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { minHeight: "100vh", background: `linear-gradient(160deg, ${C.sagePale} 0%, ${C.cream} 40%, #EBF4FA 100%)` } }, counselingPrompt && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    alignItems: "center",
    gap: 5
  } }, "\u{1F525} ", t(`${gameStatus.streak_days}\uC77C \uC5F0\uC18D`, `${gameStatus.streak_days}-Day Streak`))), /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 20px 20px", display: "flex", flexDirection: "column", gap: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 700, color: C.dark, marginBottom: 4 } }, t(`\uC548\uB155\uD558\uC138\uC694, ${user?.nickname || user?.email?.split("@")[0]}\uB2D8 \u{1F44B}`, `Hello, ${user?.nickname || user?.email?.split("@")[0]} \u{1F44B}`), isMaster && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, background: "#2D6A4F", color: "white", borderRadius: 6, padding: "2px 8px", fontWeight: 700, marginLeft: 6 } }, "MASTER")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: C.muted } }, gardenTheme.desc)), /* @__PURE__ */ React.createElement(DailyTip, { hubData: data }), /* @__PURE__ */ React.createElement(LevelBar, { levelInfo }), /* @__PURE__ */ React.createElement(
    StreakCalendar,
    {
