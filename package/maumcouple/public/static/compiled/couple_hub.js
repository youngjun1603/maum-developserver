...
function LoginGate() {
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    textAlign: "center",
    position: "relative"
  } }, /* @__PURE__ */ React.createElement("button", { onClick: toggleCoupleLang, title: "Language", style: { position: "absolute", top: 16, right: 16, fontSize: 12, fontWeight: 700, color: C.muted, cursor: "pointer", padding: "4px 10px", borderRadius: 8, border: "1px solid rgba(0,0,0,0.08)", background: "rgba(255,255,255,0.6)" } }, COUPLE_LANG === "en" ? "\uD55C" : "EN"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 72, marginBottom: 20, animation: "heartbeat 2s ease-in-out infinite" } }, SERVICE_ICON), /* @__PURE__ */ React.createElement("h1", { style: {
    fontSize: 28,
    fontWeight: 700,
    color: C.dark,
    marginBottom: 10,
...
function CoupleHubApp() {
  ...
  const TOOL_CATEGORIES = [
    ...
    },
    {
      ...
      items: [
        { icon: "\u{1F49D}", label: tl("\uC5F0\uC560 \uC720\uD615 \uD14C\uC2A4\uD2B8", "Love Type Test"), desc: tl("S\xB7R\xB7P\xB7F 4\uAC00\uC9C0 \uC720\uD615 \uC911 \uB098\uB294?", "Which love type are you? S\xB7R\xB7P\xB7F"), cost: null, view: "miniTest" },
        { icon: "\u{1F49B}", label: tl("\uCEE4\uD50C \uC2A4\uD0C0\uC77C \uD034\uC988", "Couple Style Quiz"), desc: tl("10\uBB38\uD56D\uC73C\uB85C \uBCF4\uB294 \uCEE4\uD50C \uD638\uD658\uC131", "10-question couple compatibility"), cost: null, view: "quiz" }
      ]
    },
    {
      title: tl("\u{1F4C5} \uAD00\uACC4 \uAD00\uB9AC", "\u{1F4C5} Relationship"),
      items: [
        { icon: "\u{1F331}", label: tl("\uAD00\uACC4 \uC131\uC7A5 \uCCB4\uD06C\uC778", "Relationship Check-in"), desc: tl("\uC6D4 1\uD68C \uAD00\uACC4 \uAC74\uAC15\uB3C4 \uCCB4\uD06C", "Monthly relationship health check"), cost: null, view: "checkin" },
        { icon: "\u{1F5D3}\uFE0F", label: tl("\uAE30\uB150\uC77C \uACC4\uC0B0\uAE30", "Anniversary Calculator"), desc: tl("D+N\uC77C \xB7 \uAE30\uB150\uC77C \uC54C\uB9BC", "D+N day counter & anniversary tracker"), cost: null, view: "anniversary" },
        { icon: "\u{1F5C2}\uFE0F", label: tl("\uAD00\uACC4 \uD0C0\uC784\uB77C\uC778", "Relationship Timeline"), desc: tl("\uD568\uAED8\uD55C \uC21C\uAC04\uB4E4\uC758 \uAE30\uB85D", "A visual record of your journey"), cost: null, view: "timeline" }
      ]
    }
  ];
  return /* @__PURE__ */ React.createElement("div", { style: { minHeight: "100vh", background: `linear-gradient(160deg, ${C.rosePale} 0%, ${C.cream} 40%, ${C.lavPale} 100%)` } }, /* @__PURE__ */ React.createElement("nav", { style: {
    ...
    /* @__PURE__ */ React.createElement("div", { style: { background: `linear-gradient(135deg, ${t.from}, ${t.to})`, padding: "16px 12px 12px", position: "relative", display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 30 } }, t.icon), t.cost && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 8, right: 8, fontSize: 10, fontWeight: 800, color: "white", background: "rgba(0,0,0,0.18)", backdropFilter: "blur(4px)", padding: "2px 7px", borderRadius: 100, letterSpacing: 0.3 } }, t.cost)),
    /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 10px 12px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 800, color: C.dark, marginBottom: 2, lineHeight: 1.3 } }, t.label), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: C.muted, lineHeight: 1.4 } }, t.desc))
  )))), /* @__PURE__ */ React.createElement(PartnerMomentsSection, null)), tab === "tools" && /* @__PURE__ */ React.createElement(React.Fragment, null, TOOL_CATEGORIES.map((cat) => /* @__PURE__ */ React.createElement("div", { key: cat.title, style: { marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: C.dark, marginBottom: 10 } }, cat.title), /* @__PURE__ */ React.createElement("div", { style: { background: "white", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" } }, cat.items.map((item, idx) => /* @__PURE__ */ React.createElement("button", { key: item.view, onClick: () => setView(item.view), style: {
    width: "100%",
    display: "flex",
    alignItems: "center",
    gap: 14,
