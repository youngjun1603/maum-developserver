...
function MfSnsHeroBtn({ tl }) {
  const share = () => {
    ...
    k.Share.sendDefault({
      objectType: 'feed',
      content: { title: '마음풀 — 심리검사 · AI상담 · 치유게임', description: '마음의 무게를 가볍게.', imageUrl: window.location.origin + '/static/og-share.png?v=3', link: { mobileWebUrl: window.location.origin, webUrl: window.location.origin } },
