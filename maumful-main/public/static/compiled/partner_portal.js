...
function Login({ onDone }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen flex items-center justify-center px-6", style: { background: "#F3F6F2", fontFamily: F } }, /* @__PURE__ */ React.createElement("form", { onSubmit: submit, className: "w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-7" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "font-extrabold text-lg", style: { color: BRAND } }, "\u{1F33F} \uB9C8\uC74C\uD480 \uC81C\uD734 \uC815\uC0B0 \uD3EC\uD138"), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-gray-400 mt-1" }, "\uC81C\uD734\uC0AC \uB2F4\uB2F9\uC790 \uC804\uC6A9 \uB85C\uADF8\uC778")), msg && /* @__PURE__ */ React.createElement("div", { className: "text-xs bg-red-50 text-red-600 rounded-lg px-3 py-2 mb-3" }, msg), /* @__PURE__ */ React.createElement("label", { className: "text-xs text-gray-500" }, "\uC774\uBA54\uC77C"), /* @__PURE__ */ React.createElement(
    ...
    busy ? "\uD655\uC778 \uC911\u2026" : "\uB85C\uADF8\uC778"
  ), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-gray-400 mt-4 text-center" }, "\uACC4\uC815\uC740 \uB9C8\uC74C\uD480 \uC6B4\uC601\uC790\uAC00 \uBC1C\uAE09\uD569\uB2C8\uB2E4. \uBB38\uC758: \uB2F4\uB2F9 \uC6B4\uC601\uC790")));
}
function Dashboard({ partner, onLogout }) {
  ...
  ].map(([label, val, col]) => /* @__PURE__ */ React.createElement("div", { key: label, className: "bg-white rounded-xl border border-gray-100 px-4 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-gray-400 mb-1" }, label), /* @__PURE__ */ React.createElement("div", { className: "font-extrabold text-base", style: { color: col } }, val)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl border border-gray-100 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "px-4 py-2.5 border-b border-gray-100 text-sm font-bold text-gray-700" }, "\uC815\uC0B0 \uB0B4\uC5ED"), loading ? /* @__PURE__ */ React.createElement("div", { className: "text-center text-gray-400 text-sm py-10" }, "\uBD88\uB7EC\uC624\uB294 \uC911\u2026") : rows.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center text-gray-400 text-sm py-10" }, "\uD574\uB2F9 \uAE30\uAC04 \uC815\uC0B0 \uB0B4\uC5ED\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.") : /* @__PURE__ */ React.createElement("div", { className: "overflow-x-auto" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-sm" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { className: "text-[11px] text-gray-400 bg-gray-50" }, /* @__PURE__ */ React.createElement("th", { className: "text-left font-medium px-4 py-2" }, "\uAC70\uB798\uBC88\uD638"), /* @__PURE__ */ React.createElement("th", { className: "text-left font-medium px-4 py-2" }, "\uC77C\uC2DC"), /* @__PURE__ */ React.createElement("th", { className: "text-right font-medium px-4 py-2" }, "\uACB0\uC81C\uC561"), /* @__PURE__ */ React.createElement("th", { className: "text-right font-medium px-4 py-2" }, "\uC218\uC218\uB8CC\uC728"), /* @__PURE__ */ React.createElement("th", { className: "text-right font-medium px-4 py-2" }, "\uC250\uC5B4\uC561"), /* @__PURE__ */ React.createElement("th", { className: "text-center font-medium px-4 py-2" }, "\uC0C1\uD0DC"))), /* @__PURE__ */ React.createElement("tbody", null, rows.map((r) => /* @__PURE__ */ React.createElement("tr", { key: r.charge_id, className: "border-t border-gray-50" }, /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-gray-400" }, "#", r.charge_id), /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-gray-500" }, String(r.created_at || "").slice(0, 16).replace("T", " ")), /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-right text-gray-600" }, won(r.charge_amount)), /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-right text-gray-500" }, Math.round((r.rate || 0) * 100), "%"), /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-right font-bold", style: { color: BRAND } }, won(r.share_amount)), /* @__PURE__ */ React.createElement("td", { className: "px-4 py-2 text-center" }, /* @__PURE__ */ React.createElement("span", { className: `text-[10px] px-2 py-0.5 rounded-full font-bold ${r.status === "settled" ? "bg-green-100 text-green-700" : r.status === "reversed" ? "bg-gray-100 text-gray-400" : "bg-amber-100 text-amber-700"}` }, statusKo(r.status))))))))), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-gray-400 mt-3" }, "\xB7 \uAE08\uC561\uC740 \uD655\uC815\uB41C \uC720\uD6A8\uAD6C\uB9E4 \uAE30\uC900\uC774\uBA70, \uD658\uBD88 \uBC1C\uC0DD \uC2DC \uC790\uB3D9 \uBC18\uC601\uB429\uB2C8\uB2E4. \xB7 \uC2E4\uC81C \uC9C0\uAE09 \uC5EC\uBD80\uB294 \uC0C1\uD0DC(\uC815\uC0B0\uC644\uB8CC)\uB85C \uD655\uC778\uD558\uC138\uC694.")));
}
