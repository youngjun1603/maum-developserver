const aApi = {
  ...
  async partnerCommissions(code, from, to, status) {
    return (await fetch(`/api/admin/partner-commissions?code=${code}&from=${from}&to=${to}${status ? `&status=${status}` : ""}`, { headers: this._h() })).json();
  },
  async settlePartner(body) {
    return (await fetch("/api/admin/partner-commissions/settle", { method: "POST", headers: this._h(), body: JSON.stringify(body) })).json();
  }
};
const fmtW = (n) => Number(n || 0).toLocaleString("ko-KR") + "\uC6D0";
const fmtDtAdmin = (iso) => {
  if (!iso) return "-";
...
function AdminPartners() {
  ...
  const [ledgerFrom, setLedgerFrom] = useS(() => iso(new Date(Date.now() - 30 * 864e5)));
  const [ledgerTo, setLedgerTo] = useS(() => iso(/* @__PURE__ */ new Date()));
  const loadLedger = async (code) => {
    const r = await aApi.partnerCommissions(code || selected, ledgerFrom, ledgerTo);
  ...
  const downloadCsv = () => {
    ...
    a.download = `\uC815\uC0B0_${selected}_${ledgerFrom}_${ledgerTo}.csv`;
    a.click();
    URL.revokeObjectURL(a.href);
  };
  const markSettled = async () => {
    if (!confirm(`${selected} \xB7 ${ledgerFrom}~${ledgerTo}
\uC774 \uAE30\uAC04\uC758 \uBBF8\uC815\uC0B0 \uAC74\uC744 '\uC815\uC0B0\uC644\uB8CC'\uB85C \uD45C\uC2DC\uD560\uAE4C\uC694? (\uC2E4\uC81C \uC9C0\uAE09\uC740 \uBCC4\uB3C4)`)) return;
    const ref = prompt("\uC815\uC0B0 \uCC38\uC870(\uC120\uD0DD, \uC608: 2026-07 \uC774\uCCB4)", "") || void 0;
    const r = await aApi.settlePartner({ code: selected, from: ledgerFrom, to: ledgerTo, ref });
    if (r.success) {
      alert(`${r.settled}\uAC74 \uC815\uC0B0\uC644\uB8CC \uCC98\uB9AC`);
      loadLedger(selected);
    }
  };
  useE(() => {
  ...
  const handleCreate = async () => {
    ...
    if (r.success) {
      setMsg("\uD30C\uD2B8\uB108 \uB4F1\uB85D \uC644\uB8CC");
      setShowCreate(false);
      setForm({ code: "", name: "", sso_secret: "", revenue_share_rate: "0", welcome_message: "", featured_tests: "", primary_color: "#2D6A4F", contact_email: "", commission_start: "", commission_end: "" });
  ...
  })))), settlement && /* @__PURE__ */ React.createElement("div", { style: { background: "#FFF9F0", border: "1px solid #F5DFA0", borderRadius: 10, padding: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700, marginBottom: 10, color: "#92400E" } }, "\u{1F4B0} ", statsMonth, " \uC815\uC0B0 \uB0B4\uC5ED"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, fontSize: 13 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "#9A9A9A" } }, "\uC2E0\uADDC \uC720\uC785: "), /* @__PURE__ */ React.createElement("strong", null, (settlement.new_users || 0).toLocaleString(), "\uBA85")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "#9A9A9A" } }, "\uACB0\uC81C \uC804\uD658: "), /* @__PURE__ */ React.createElement("strong", null, (settlement.paid_users || 0).toLocaleString(), "\uBA85")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "#9A9A9A" } }, "\uB9C8\uC74C\uD480 \uC9C1\uC811\uB9E4\uCD9C: "), /* @__PURE__ */ React.createElement("strong", null, fmtW(settlement.total_revenue))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "#9A9A9A" } }, "\uC250\uC5B4\uC728: "), /* @__PURE__ */ React.createElement("strong", null, ((settlement.share_rate || 0) * 100).toFixed(0), "%")), /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1/-1", borderTop: "1px solid #F5DFA0", paddingTop: 8, marginTop: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#92400E", fontWeight: 700 } }, "\uC815\uC0B0 \uC9C0\uAE09\uC561: "), /* @__PURE__ */ React.createElement("strong", { style: { fontSize: 16, color: "#92400E" } }, fmtW(settlement.share_amount)), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#9A9A9A", marginLeft: 8 } }, "(\uB9C8\uC74C\uD480 \uBCF4\uC720: ", fmtW(settlement.maumful_revenue), ")")))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16, borderTop: "1px solid rgba(0,0,0,.08)", paddingTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10, flexWrap: "wrap", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700 } }, "\u{1F4D2} \uC815\uC0B0 \uC6D0\uC7A5 (\uAE30\uAC04\uBCC4 \uC0C1\uC138)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement("input", { type: "date", value: ledgerFrom, onChange: (e) => setLedgerFrom(e.target.value), style: { padding: "6px 8px", border: "1px solid #E0E0E0", borderRadius: 6, fontSize: 12 } }), /* @__PURE__ */ React.createElement("span", { style: { color: "#9A9A9A" } }, "~"), /* @__PURE__ */ React.createElement("input", { type: "date", value: ledgerTo, onChange: (e) => setLedgerTo(e.target.value), style: { padding: "6px 8px", border: "1px solid #E0E0E0", borderRadius: 6, fontSize: 12 } }), /* @__PURE__ */ React.createElement("button", { onClick: () => loadLedger(selected), style: { padding: "6px 12px", background: "#2D6A4F", color: "white", border: "none", borderRadius: 6, fontSize: 12, cursor: "pointer" } }, "\uC870\uD68C"))), ledger && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, flexWrap: "wrap", fontSize: 12, color: "#5A5A5A", marginBottom: 10, background: "#F8F8F5", borderRadius: 8, padding: "10px 14px" } }, /* @__PURE__ */ React.createElement("span", null, "\uAC74\uC218 ", /* @__PURE__ */ React.createElement("strong", null, (((_i = ledger.totals) == null ? void 0 : _i.cnt) || 0).toLocaleString())), /* @__PURE__ */ React.createElement("span", null, "\uACB0\uC81C\uC561 ", /* @__PURE__ */ React.createElement("strong", null, fmtW((_j = ledger.totals) == null ? void 0 : _j.revenue))), /* @__PURE__ */ React.createElement("span", null, "\uC250\uC5B4 \uD569\uACC4 ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#92400E" } }, fmtW((_k = ledger.totals) == null ? void 0 : _k.share))), /* @__PURE__ */ React.createElement("span", null, "\uBBF8\uC815\uC0B0 ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#B45309" } }, fmtW((_l = ledger.totals) == null ? void 0 : _l.unsettled)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 10 } }, /* @__PURE__ */ React.createElement("button", { onClick: downloadCsv, disabled: !(ledger.rows || []).length, style: { padding: "7px 14px", background: "#1F6FEB", color: "white", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: (ledger.rows || []).length ? "pointer" : "default", opacity: (ledger.rows || []).length ? 1 : 0.5 } }, "\u2B07 CSV \uB2E4\uC6B4\uB85C\uB4DC"), /* @__PURE__ */ React.createElement("button", { onClick: markSettled, disabled: !((_m = ledger.totals) == null ? void 0 : _m.unsettled), style: { padding: "7px 14px", background: "white", color: "#92400E", border: "1px solid #F5DFA0", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: ((_n = ledger.totals) == null ? void 0 : _n.unsettled) ? "pointer" : "default", opacity: ((_o = ledger.totals) == null ? void 0 : _o.unsettled) ? 1 : 0.5 } }, "\uC774 \uAE30\uAC04 \uC815\uC0B0\uC644\uB8CC \uCC98\uB9AC")), (ledger.rows || []).length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { padding: 20, textAlign: "center", color: "#9A9A9A", fontSize: 12 } }, "\uD574\uB2F9 \uAE30\uAC04 \uC801\uB9BD \uB0B4\uC5ED\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 (\uC2E4\uACB0\uC81C\uAC00 \uC313\uC774\uBA74 \uD45C\uC2DC\uB429\uB2C8\uB2E4)") : /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto" } }, /* @__PURE__ */ React.createElement("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 11 } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#F0F0ED", textAlign: "left" } }, ["\uC77C\uC2DC", "\uD68C\uC6D0", "\uC0C1\uD488", "\uACB0\uC81C\uC561", "\uC728", "\uC250\uC5B4\uC561", "\uC0C1\uD0DC"].map((h) => /* @__PURE__ */ React.createElement("th", { key: h, style: { padding: "6px 8px", fontWeight: 700, color: "#666" } }, h)))), /* @__PURE__ */ React.createElement("tbody", null, (ledger.rows || []).map((r) => /* @__PURE__ */ React.createElement("tr", { key: r.charge_id, style: { borderBottom: "1px solid #F0F0F0" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", color: "#888" } }, (r.created_at || "").slice(0, 10)), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, r.user_email_masked), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, r.package_key || "-"), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, fmtW(r.charge_amount)), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, ((r.rate || 0) * 100).toFixed(0), "%"), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", fontWeight: 700, color: "#92400E" } }, fmtW(r.share_amount)), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 100, background: r.status === "settled" ? "#D8F3DC" : r.status === "reversed" ? "#EEE" : "#FEF3C7", color: r.status === "settled" ? "#1A6B3C" : r.status === "reversed" ? "#888" : "#92400E" } }, r.status === "settled" ? "\uC815\uC0B0\uC644\uB8CC" : r.status === "reversed" ? "\uD658\uBD88" : "\uBBF8\uC815\uC0B0")))))))))) : /* @__PURE__ */ React.createElement("div", { style: { background: "white", border: "1px solid rgba(0,0,0,.08)", borderRadius: 12, padding: 32, textAlign: "center", color: "#9A9A9A" } }, "\uD30C\uD2B8\uB108\uB97C \uC120\uD0DD\uD558\uBA74 \uC0C1\uC138 \uD1B5\uACC4\uC640 \uC815\uC0B0 \uB0B4\uC5ED\uC744 \uD655\uC778\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4")));
}
