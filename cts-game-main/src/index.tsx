...
app.post('/api/game/session', async (c) => {
  ...
  const UNLOCK_MAP: Record<number, string[]> = {
    1: ['garden', 'mood', 'worry', 'qt'],
    2: ['garden', 'mood', 'worry', 'qt', 'efmt', 'gratitude', 'burnout'],
    3: ['garden', 'mood', 'worry', 'qt', 'efmt', 'gratitude', 'burnout', 'focus'],
    4: ['garden', 'mood', 'worry', 'qt', 'efmt', 'gratitude', 'burnout', 'focus', 'tree'],
    5: ['garden', 'mood', 'worry', 'qt', 'efmt', 'gratitude', 'burnout', 'focus', 'tree'],
    6: ['garden', 'mood', 'worry', 'qt', 'efmt', 'gratitude', 'burnout', 'focus', 'tree'],
  }
