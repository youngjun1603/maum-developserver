...
function NumberRound({ config, roundIndex, totalRounds, onDone }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", flex: 1, padding: "0 24px" }, children: [
    ...
    phase === "breathe" && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 16, fontWeight: 600, color: FC.dark }, children: "\uC7A0\uAE50 \uB9C8\uC74C\uC744 \uAC00\uB2E4\uB4EC\uC5B4\uC694" }),
      /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, color: FC.muted, textAlign: "center", lineHeight: 1.7 }, children: [
        "\uC22B\uC790\uAC00 \uD558\uB098\uC529 \uB098\uD0C0\uB0A0 \uAC70\uC608\uC694",
        /* @__PURE__ */ jsx("br", {}),
        "\uC21C\uC11C\uB300\uB85C \uAE30\uC5B5\uD574 \uB450\uC138\uC694"
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, color: FC.sky, fontWeight: 700 }, children: [
        config.span,
        "\uC790\uB9AC \uC22B\uC790\uB97C \uAE30\uC5B5\uD558\uC138\uC694"
      ] })
    ] }),
    phase === "show" && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 13, color: FC.muted }, children: currentIdx < numbers.length ? `${currentIdx + 1} / ${numbers.length}` : "\uC774\uC81C \uC785\uB825\uD558\uC138\uC694!" })
    ] }),
    phase === "input" && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, width: "100%" }, children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark }, children: "\uAE30\uC5B5\uD55C \uC22B\uC790\uB97C \uC21C\uC11C\uB300\uB85C \uC785\uB825\uD558\uC138\uC694" }),
      /* @__PURE__ */ jsx("div", { style: {
        display: "flex",
        gap: 10,
        justifyContent: "center",
    ...
    phase === "result" && result && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 20, fontWeight: 700, color: FC.dark }, children: result.perfect ? "\uC644\uBCBD\uD574\uC694!" : `${result.correct}/${result.total} \uB9DE\uCDC4\uC5B4\uC694` }),
      /* @__PURE__ */ jsx("div", { style: {
        display: "flex",
        gap: 8,
        justifyContent: "center",
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: FC.muted, marginBottom: 4 }, children: "\uC785\uB825" }),
      ...
      /* @__PURE__ */ jsx("button", { onClick: () => onDone(result.score), style: {
...
function GridRound({ config, roundIndex, totalRounds, onDone }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", flex: 1, padding: "0 24px" }, children: [
    ...
    phase === "show" && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark, textAlign: "center" }, children: showCountdown > 0 ? `${showCountdown}\uCD08 \uD6C4 \uD328\uD134\uC774 \uC0AC\uB77C\uC838\uC694` : "\uD328\uD134\uC744 \uAE30\uC5B5\uD558\uC138\uC694!" }),
      /* @__PURE__ */ jsx("div", { style: {
        display: "grid",
    ...
    phase === "input" && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: 15, fontWeight: 700, color: FC.dark }, children: "\uAE30\uC5B5\uD55C \uCE78\uC744 \uB20C\uB7EC\uBCF4\uC138\uC694" }),
    ...
    phase === "result" && result && /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 20, fontWeight: 700, color: FC.dark }, children: result.perfect ? "\uC644\uBCBD\uD574\uC694!" : `${result.correct}\uAC1C \uB9DE\uCD94\uACE0 ${result.wrong}\uAC1C \uD2C0\uB838\uC5B4\uC694` }),
      /* @__PURE__ */ jsx("div", { style: {
        display: "grid",
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 14, fontSize: 11 }, children: [
        /* @__PURE__ */ jsx("span", { style: { color: FC.sage }, children: "\u25A0 \uC815\uB2F5" }),
        /* @__PURE__ */ jsx("span", { style: { color: FC.amber }, children: "\u25A0 \uB193\uCE68" }),
        /* @__PURE__ */ jsx("span", { style: { color: FC.warn }, children: "\u25A0 \uC624\uB2F5" })
      ] }),
...
function FocusGame({ onExit }) {
  ...
  if (screen === "intro") return /* @__PURE__ */ jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 16, fontWeight: 700, color: FC.dark }, children: "\uB9C8\uC74C \uC9D1\uC911\uB825" }),
    ...
    /* @__PURE__ */ jsx("div", { style: {
      ...
      textAlign: "center"
    }, children: /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, color: FC.indigo, fontWeight: 600 }, children: [
      "\uCD1D ",
      totalRounds,
      "\uB77C\uC6B4\uB4DC \xB7 \uC22B\uC790 \uAE30\uC5B5 + \uD328\uD134 \uAE30\uC5B5 \uAD50\uCC28 \uC9C4\uD589"
    ] }) }),
    /* @__PURE__ */ jsx("button", { onClick: handleStart, style: {
      fontFamily: "'Noto Sans KR',sans-serif",
  ...
  if (screen === "done") {
    ...
    return /* @__PURE__ */ jsx("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 32 }, children: [
        ...
        /* @__PURE__ */ jsx("h2", { style: { fontSize: 24, fontWeight: 700, color: FC.dark, marginBottom: 8, fontFamily: "'Noto Serif KR',serif" }, children: "\uD6C8\uB828 \uC644\uB8CC!" }),
        /* @__PURE__ */ jsx("div", { style: { fontSize: 15, color: grade.color, fontWeight: 700 }, children: grade.label }),
        isNewRecord && /* @__PURE__ */ jsx("div", { style: {
          display: "inline-flex",
          alignItems: "center",
          gap: 6,
          marginTop: 12,
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 20 }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 13, color: FC.muted }, children: "\uCD5C\uC885 \uC810\uC218" }),
          ...
          personalBest === null && /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: FC.sage, marginTop: 4 }, children: "\uCCAB \uAE30\uB85D\uC774\uC5D0\uC694! \u{1F389}" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: FC.muted, marginBottom: 10 }, children: "\uB77C\uC6B4\uB4DC\uBCC4 \uC810\uC218" }),
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 10 }, children: [
          ...
          }, children: isSaving ? "\uC800\uC7A5 \uC911..." : "\u2713 \uC800\uC7A5\uD558\uACE0 \uB098\uAC00\uAE30" })
        ] }),
