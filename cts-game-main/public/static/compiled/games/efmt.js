...
function EFMTGame({ onExit }) {
  ...
  if (screen === "intro") return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 15, fontWeight: 700, color: GE.dark, fontFamily: "'Noto Serif KR',serif" }, children: "\uAC10\uC815\uAF43 \uCC3E\uAE30" })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, padding: "24px 20px", overflowY: "auto" }, children: [
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: GE.muted, marginBottom: 12, textAlign: "center" }, children: "\uAE30\uC05C \uAF43\uB9CC \uBE60\uB974\uAC8C \uD074\uB9AD\uD558\uC138\uC694" }),
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: GE.muted, marginBottom: 10 }, children: "\uB09C\uC774\uB3C4 \uC120\uD0DD" }),
      ...
      personalBest !== null && /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("span", { style: { fontSize: 13, fontWeight: 700, color: GE.amber }, children: [
          "\uB0B4 \uCD5C\uACE0 \uAE30\uB85D: ",
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, fontWeight: 700, color: GE.dark }, children: [
              "\uB77C\uC6B4\uB4DC ",
              round,
              " / ",
              cfg.rounds
      ...
      }, children: isCritical ? "\u23F0 \uC11C\uB458\uB7EC\uC694!" : `\uAE30\uC05C \uAF43 ${remaining}\uAC1C \uB0A8\uC558\uC5B4\uC694 \xB7 \uB2E4\uB978 \uAF43\uC740 \uD074\uB9AD\uD558\uC9C0 \uB9C8\uC138\uC694` }),
  ...
  if (screen === "result") {
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("h3", { style: { fontSize: 20, fontWeight: 700, color: GE.dark, marginBottom: 8, fontFamily: "'Noto Serif KR',serif" }, children: [
        "\uB77C\uC6B4\uB4DC ",
        last.round,
        " \uC644\uB8CC"
      ] }),
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: GE.muted }, children: "\uBC1C\uACAC" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 22, fontWeight: 700, color: GE.warn }, children: last.missed }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: GE.muted }, children: "\uB193\uCE68" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: GE.muted }, children: "\uC815\uD655\uB3C4" })
        ] }),
        last.avgReaction > 0 && /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: GE.muted }, children: "\uBC18\uC751\uC18D\uB3C4" })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
  ...
  if (screen === "done") {
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 20 }, children: [
        ...
        /* @__PURE__ */ jsx("h2", { style: { fontSize: 22, fontWeight: 700, color: GE.dark, fontFamily: "'Noto Serif KR',serif" }, children: "\uAC10\uC815 \uD6C8\uB828 \uC644\uB8CC!" }),
        ...
        personalBest !== null && !isNewRecord && /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: GE.muted, marginTop: 4 }, children: [
          ...
          personalBest.toLocaleString(),
          "\uC810",
          computedScore > 0 && ` \xB7 \uCC28\uC774 ${(personalBest - computedScore).toLocaleString()}\uC810`
        ] }),
        personalBest === null && /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: GE.sage, marginTop: 4 }, children: "\uCCAB \uAE30\uB85D\uC774\uC5D0\uC694! \u{1F389}" })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: {
        background: "white",
        borderRadius: 18,
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: GE.muted, marginBottom: 12 }, children: "\uD6C8\uB828 \uACB0\uACFC" }),
        ...
        (bestCombo >= 3 || avgAcc >= 75) && /* @__PURE__ */ jsxs("div", { style: { marginTop: 12, paddingTop: 10, borderTop: "1px solid rgba(0,0,0,0.06)", display: "flex", gap: 8, flexWrap: "wrap" }, children: [
          bestCombo >= 3 && /* @__PURE__ */ jsxs("span", { style: {
            fontSize: 11,
            color: GE.amber,
            fontWeight: 700,
            ...
            "\u{1F525} \uCF64\uBCF4 \uBCF4\uB108\uC2A4 +",
            bestCombo >= 10 ? bestCombo * 15 : bestCombo >= 5 ? bestCombo * 10 : bestCombo * 6,
            "\uC810"
          ] }),
          avgAcc >= 75 && /* @__PURE__ */ jsxs("span", { style: {
            fontSize: 11,
            color: GE.sage,
            fontWeight: 700,
      ...
      /* @__PURE__ */ jsx("div", { style: { flex: 1, overflowY: "auto", marginBottom: 16 }, children: roundStats.map((s) => /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, fontWeight: 600, color: GE.dark }, children: [
            "\uB77C\uC6B4\uB4DC ",
            s.round
          ] }),
