const MOOD_EMOTIONS = [
  { id: "happy", emoji: "\u{1F60A}", label: "\uD589\uBCF5", color: "#F5C842", bg: "#FFFAE0", textColor: "#8B6800" },
  { id: "calm", emoji: "\u{1F60C}", label: "\uD3C9\uC628", color: "#7BC4A0", bg: "#E8F5EE", textColor: "#2A6B4A" },
  { id: "tired", emoji: "\u{1F634}", label: "\uD53C\uACE4", color: "#9BB0C0", bg: "#EEF3F7", textColor: "#3A5060" },
  { id: "anxious", emoji: "\u{1F630}", label: "\uBD88\uC548", color: "#F5A050", bg: "#FEF0E4", textColor: "#8B4000" },
  { id: "sad", emoji: "\u{1F622}", label: "\uC2AC\uD514", color: "#6B9ACB", bg: "#EAF1F9", textColor: "#2A4A7A" },
  { id: "angry", emoji: "\u{1F624}", label: "\uD654\uB0A8", color: "#E86C6C", bg: "#FDEAEA", textColor: "#7A2020" }
];
...
function getMoodInsight(history) {
  ...
  const msgs = {
    happy: "\uCD5C\uADFC \uD589\uBCF5\uD55C \uB0A0\uC774 \uB9CE\uC558\uC5B4\uC694. \uADF8 \uC5D0\uB108\uC9C0\uB97C \uACC4\uC18D \uC774\uC5B4\uAC00\uC138\uC694 \u{1F31F}",
    calm: "\uD3C9\uC628\uD568\uC744 \uC790\uC8FC \uB290\uB07C\uACE0 \uC788\uC5B4\uC694. \uB9C8\uC74C\uC774 \uC548\uC815\uB418\uC5B4 \uC788\uB124\uC694 \u{1F33F}",
    tired: "\uD53C\uB85C\uAC00 \uC313\uC5EC \uC788\uB294 \uAC83 \uAC19\uC544\uC694. \uCDA9\uBD84\uD55C \uD734\uC2DD\uC774 \uD544\uC694\uD574\uC694 \u{1F634}",
    anxious: "\uBD88\uC548\uD55C \uB0A0\uC774 \uB9CE\uC558\uB124\uC694. \uD638\uD761 \uD6C8\uB828\uC774 \uB3C4\uC6C0\uC774 \uB420 \uC218 \uC788\uC5B4\uC694 \u{1F4A7}",
    sad: "\uC2AC\uD508 \uAC10\uC815\uC774 \uB9CE\uC774 \uCC3E\uC544\uC654\uAD70\uC694. \uAC10\uC815\uC740 \uC9C0\uB098\uAC00\uC694. \uAD1C\uCC2E\uC544\uC694 \u{1F327}\uFE0F",
    angry: "\uD654\uAC00 \uB9CE\uC774 \uB0AC\uB358 \uC2DC\uAC04\uC774\uC5C8\uB124\uC694. \uADF8 \uAC10\uC815\uB3C4 \uC18C\uC911\uD574\uC694 \u{1F525}"
  };
...
function MoodGame({ onExit }) {
  ...
  if (screen === "loading") {
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      gap: 12
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 40, animation: "float 2s ease-in-out infinite" } }, "\u{1F3A8}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: MC.muted, fontFamily: "'Noto Sans KR',sans-serif" } }, "\uAC10\uC815 \uAE30\uB85D\uC744 \uBD88\uB7EC\uC624\uB294 \uC911..."));
  }
  function shareMood() {
...
https://game.maumful.com`;
    navigator.share ? navigator.share({ title: "\uC624\uB298\uC758 \uAC10\uC815 \uAE30\uB85D", text }).catch(() => {
  ...
  if (screen === "done") {
    ...
    } }, "\uC624\uB298\uC758 \uAC10\uC815\uC774 \uAE30\uB85D\uB410\uC5B4\uC694"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: MC.muted, marginBottom: 24, lineHeight: 1.8 } }, e.label, " \xB7 \uAC15\uB3C4 ", "\u2B50".repeat(intensity), note && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { fontStyle: "italic", color: MC.text } }, '"', note, '"'))), result?.expGained > 0 && /* @__PURE__ */ React.createElement("div", { style: {
      background: "rgba(255,255,255,0.8)",
      borderRadius: 16,
      padding: "14px 28px",
      marginBottom: 24
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 700, color: MC.accent } }, "+", result.expGained), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: MC.muted } }, "\uACBD\uD5D8\uCE58")), /* @__PURE__ */ React.createElement("button", { onClick: shareMood, style: {
      ...mbtn("rgba(255,255,255,0.85)", MC.muted, { borderRadius: 13, width: "100%", maxWidth: 280 }),
      padding: "11px",
      fontSize: 13,
      marginBottom: 10
    } }, "\u{1F495} \uD30C\uD2B8\uB108\uC640 \uACF5\uC720\uD558\uAE30"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, width: "100%", maxWidth: 280 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setScreen("calendar"), style: {
      ...mbtn("rgba(255,255,255,0.85)", MC.muted, { borderRadius: 13, flex: 1 }),
      padding: "12px",
      fontSize: 13
    } }, "\u{1F4C5} \uB2EC\uB825 \uBCF4\uAE30"), /* @__PURE__ */ React.createElement("button", { onClick: onExit, style: {
  ...
  if (screen === "calendar") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      padding: "6px 14px",
      fontSize: 12
    } }, "\u2190 \uB4A4\uB85C"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" } }, "\u{1F3A8} 30\uC77C \uAC10\uC815 \uB2EC\uB825"), /* @__PURE__ */ React.createElement("div", { style: { width: 64 } })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "20px 16px 28px" } }, insight2 && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: insight2.textColor, marginBottom: 5, letterSpacing: "0.5px" } }, insight2.emoji, " \uCD5C\uADFC 30\uC77C \uAC10\uC815 \uC778\uC0AC\uC774\uD2B8"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: MC.text, lineHeight: 1.6 } }, insight2.msg)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 16, justifyContent: "center" } }, MOOD_EMOTIONS.map((e) => /* @__PURE__ */ React.createElement("div", { key: e.id, style: {
      display: "flex",
      alignItems: "center",
      gap: 3,
      padding: "3px 8px",
      ...
      marginBottom: 16
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: MC.text, marginBottom: 10 } }, "\u{1F4CA} \uAC10\uC815 \uBD84\uD3EC"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } }, MOOD_EMOTIONS.map((e) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: e.id, style: {
        ...
        background: e.bg,
        border: `1px solid ${e.color}40`
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12 } }, e.emoji), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: e.textColor } }, count, "\uC77C (", pct, "%)"));
    }))), history.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: MC.text, marginBottom: 10 } }, "\uCD5C\uADFC \uAE30\uB85D"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 7 } }, history.slice(0, 7).map((entry, i) => {
  ...
  if (screen === "checkin_emotion") {
    return /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      padding: "6px 14px",
      fontSize: 12
    } }, "\u2190 \uB4A4\uB85C"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" } }, "\uC624\uB298\uC758 \uAC10\uC815"), /* @__PURE__ */ React.createElement("div", { style: { width: 64 } })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, padding: "28px 20px 24px", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("p", { style: {
      fontSize: 15,
      color: MC.muted,
      textAlign: "center",
      marginBottom: 28,
      lineHeight: 1.7,
      fontFamily: "'Noto Sans KR',sans-serif"
    } }, "\uC9C0\uAE08 \uC774 \uC21C\uAC04, \uC5B4\uB5A4 \uAC10\uC815\uC774", /* @__PURE__ */ React.createElement("br", null), "\uAC00\uC7A5 \uD06C\uAC8C \uB290\uAEF4\uC9C0\uB098\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 } }, MOOD_EMOTIONS.map((e) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: e.id,
        onClick: () => {
  ...
  if (screen === "checkin_detail") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      textAlign: "center",
      fontFamily: "'Noto Sans KR',sans-serif"
    } }, "\uAC10\uC815\uC758 \uAC15\uB3C4\uB294?"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", gap: 10 } }, [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ React.createElement("button", { key: n, onClick: () => setIntensity(n), style: {
      fontSize: 30,
      background: "none",
      border: "none",
      cursor: "pointer",
      ...
      marginTop: 8,
      fontFamily: "'Noto Sans KR',sans-serif"
    } }, ["", "\uB9E4\uC6B0 \uC57D\uD558\uAC8C", "\uC57D\uD558\uAC8C", "\uBCF4\uD1B5", "\uAC15\uD558\uAC8C", "\uB9E4\uC6B0 \uAC15\uD558\uAC8C"][intensity])), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: {
      fontSize: 13,
      fontWeight: 700,
      color: MC.text,
      marginBottom: 8,
      fontFamily: "'Noto Sans KR',sans-serif"
    } }, "\uD55C \uB9C8\uB514 ", /* @__PURE__ */ React.createElement("span", { style: { color: MC.muted, fontWeight: 400 } }, "(\uC120\uD0DD\uC0AC\uD56D)")), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        value: note,
    ...
    } }, saving ? "\uC800\uC7A5 \uC911..." : "\uC624\uB298\uC758 \uAC10\uC815 \uAE30\uB85D\uD558\uAE30 \u{1F3A8}")));
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    backdropFilter: "blur(10px)",
    borderBottom: "1px solid rgba(0,0,0,0.06)"
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 20 } }, "\u{1F3A8}"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" } }, "\uAC10\uC815 \uC218\uCC44\uD654")), /* @__PURE__ */ React.createElement("button", { onClick: onExit, style: {
    ...mbtn("rgba(0,0,0,0.06)", MC.muted, { borderRadius: 9 }),
    padding: "6px 13px",
    fontSize: 12
  } }, "\uD5C8\uBE0C\uB85C \u2192")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "20px 16px 32px" } }, todayDone && todayEmotionData ? /* @__PURE__ */ React.createElement("div", { style: {
    ...
    letterSpacing: "0.5px",
    fontFamily: "'Noto Sans KR',sans-serif"
  } }, "\uC624\uB298\uC758 \uAC10\uC815 \u2713"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 40 } }, todayEmotionData.emoji), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 17,
    fontWeight: 700,
    color: MC.text,
    marginBottom: 3,
    ...
    letterSpacing: "0.5px",
    fontFamily: "'Noto Sans KR',sans-serif"
  } }, "\uC624\uB298\uC758 \uAC10\uC815"), /* @__PURE__ */ React.createElement("div", { style: {
    fontSize: 14,
    color: MC.text,
    fontWeight: 500,
    marginBottom: 16,
    lineHeight: 1.7,
    fontFamily: "'Noto Sans KR',sans-serif"
  } }, "\uC624\uB298\uC758 \uAC10\uC815\uC744 \uAE30\uB85D\uD574\uBCF4\uC138\uC694.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: MC.muted, fontSize: 12 } }, "\uAC10\uC815\uC744 \uC54C\uC544\uCC28\uB9AC\uB294 \uAC83\uC774 \uCE58\uC720\uC758 \uC2DC\uC791\uC774\uC5D0\uC694.")), /* @__PURE__ */ React.createElement("button", { onClick: () => setScreen("checkin_emotion"), style: {
    ...mbtn(`linear-gradient(135deg, ${MC.accent}, #5AA888)`),
    width: "100%",
    padding: "13px",
    fontSize: 14,
    boxShadow: `0 4px 16px ${MC.accent}40`
  } }, "\u{1F3A8} \uC624\uB298\uC758 \uAC10\uC815 \uAE30\uB85D\uD558\uAE30")), /* @__PURE__ */ React.createElement("div", { style: {
    background: "rgba(255,255,255,0.8)",
    borderRadius: 16,
    padding: "16px",
    marginBottom: 20,
    ...
    cursor: "pointer",
    fontFamily: "'Noto Sans KR',sans-serif"
  } }, "\uC804\uCCB4 \uBCF4\uAE30 \u2192")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, justifyContent: "space-between" } }, recentDays.map(({ iso, dow, entry }) => {
    const e = entry ? MOOD_MAP[entry.emotion] : null;
    const isToday = iso === today;
    ...
    letterSpacing: "0.5px",
    fontFamily: "'Noto Sans KR',sans-serif"
  } }, insight.emoji, " \uAC10\uC815 \uC778\uC0AC\uC774\uD2B8"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: MC.text, lineHeight: 1.6, fontFamily: "'Noto Sans KR',sans-serif" } }, insight.msg))));
}
