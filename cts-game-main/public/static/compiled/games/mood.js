...
function MoodGame({ onExit }) {
  ...
  if (screen === "loading") {
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsx("div", { style: { fontSize: 13, color: MC.muted, fontFamily: "'Noto Sans KR',sans-serif" }, children: "\uAC10\uC815 \uAE30\uB85D\uC744 \uBD88\uB7EC\uC624\uB294 \uC911..." })
    ] });
  }
  function shareMood() {
  ...
  if (screen === "done") {
    ...
    return /* @__PURE__ */ jsxs("div", { style: {
      ...
      result?.expGained > 0 && /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: MC.muted }, children: "\uACBD\uD5D8\uCE58" })
      ] }),
      /* @__PURE__ */ jsx("button", { onClick: shareMood, style: {
  ...
  if (screen === "calendar") {
    ...
    return /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" }, children: "\u{1F3A8} 30\uC77C \uAC10\uC815 \uB2EC\uB825" }),
      ...
      /* @__PURE__ */ jsxs("div", { style: { flex: 1, overflowY: "auto", padding: "20px 16px 28px" }, children: [
        ...
        history.length > 0 && /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: MC.text, marginBottom: 10 }, children: "\u{1F4CA} \uAC10\uC815 \uBD84\uD3EC" }),
        ...
        history.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: MC.text, marginBottom: 10 }, children: "\uCD5C\uADFC \uAE30\uB85D" }),
  ...
  if (screen === "checkin_emotion") {
    return /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" }, children: "\uC624\uB298\uC758 \uAC10\uC815" }),
        /* @__PURE__ */ jsx("div", { style: { width: 64 } })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { style: { flex: 1, padding: "28px 20px 24px", display: "flex", flexDirection: "column" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: 28 }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: {
            ...
            marginTop: 8,
            fontFamily: "'Noto Sans KR',sans-serif"
          }, children: ["", "\uB9E4\uC6B0 \uC57D\uD558\uAC8C", "\uC57D\uD558\uAC8C", "\uBCF4\uD1B5", "\uAC15\uD558\uAC8C", "\uB9E4\uC6B0 \uAC15\uD558\uAC8C"][intensity] })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: 24 }, children: [
          /* @__PURE__ */ jsxs("div", { style: {
            ...
            "\uD55C \uB9C8\uB514 ",
            /* @__PURE__ */ jsx("span", { style: { color: MC.muted, fontWeight: 400 }, children: "(\uC120\uD0DD\uC0AC\uD56D)" })
          ] }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
        ...
        }, children: saving ? "\uC800\uC7A5 \uC911..." : "\uC624\uB298\uC758 \uAC10\uC815 \uAE30\uB85D\uD558\uAE30 \u{1F3A8}" })
      ] })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", background: MC.bg, overflow: "hidden" }, children: [
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 15, fontWeight: 700, color: MC.text, fontFamily: "'Noto Serif KR',serif" }, children: "\uAC10\uC815 \uC218\uCC44\uD654" })
      ] }),
      /* @__PURE__ */ jsx("button", { onClick: onExit, style: {
        ...mbtn("rgba(0,0,0,0.06)", MC.muted, { borderRadius: 9 }),
        padding: "6px 13px",
    ...
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, overflowY: "auto", padding: "20px 16px 32px" }, children: [
      todayDone && todayEmotionData ? /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: {
          ...
          "\uC624\uB298\uC758 \uAC10\uC815\uC744 \uAE30\uB85D\uD574\uBCF4\uC138\uC694.",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("span", { style: { color: MC.muted, fontSize: 12 }, children: "\uAC10\uC815\uC744 \uC54C\uC544\uCC28\uB9AC\uB294 \uAC83\uC774 \uCE58\uC720\uC758 \uC2DC\uC791\uC774\uC5D0\uC694." })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => setScreen("checkin_emotion"), style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }, children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: MC.text, fontFamily: "'Noto Sans KR',sans-serif" }, children: "\u{1F4C5} \uCD5C\uADFC 7\uC77C" }),
          /* @__PURE__ */ jsx("button", { onClick: () => setScreen("calendar"), style: {
            background: "none",
            border: "none",
            fontSize: 11,
