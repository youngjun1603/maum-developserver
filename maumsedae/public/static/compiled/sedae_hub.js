...
const loadConfig = () => {
  try {
    return JSON.parse(localStorage.getItem("sedae_config") || "null");
  } catch {
    return null;
  }
};
...
const MODES = [
  { key: "receive", emoji: "\u{1F442}", title: "\uC218\uC2E0 \uD1B5\uC5ED", desc: '"\uC800 \uB9D0\uC774 \uBB34\uC2A8 \uB73B\uC774\uC57C?"', ex: "\uADF8 \uB9D0\uC758 \uC18D\uB73B\uC774 \uAD81\uAE08\uD560 \uB54C", placeholder: "\uB4E4\uC740 \uB9D0\uC744 \uADF8\uB300\uB85C \uBD99\uC5EC\uB123\uC5B4 \uBCF4\uC138\uC694." },
  { key: "send", emoji: "\u270D\uFE0F", title: "\uBC1C\uC2E0 \uD1B5\uC5ED", desc: '"\uC774\uAC78 \uC5B4\uB5BB\uAC8C \uB9D0\uD558\uC9C0?"', ex: "\uBD80\uB52A\uD788\uC9C0 \uC54A\uAC8C \uB9D0\uD558\uACE0 \uC2F6\uC744 \uB54C", placeholder: "\uD558\uACE0 \uC2F6\uC740 \uB9D0\uC744 \uC801\uC5B4 \uBCF4\uC138\uC694." },
  { key: "mediate", emoji: "\u{1F54A}\uFE0F", title: "\uC911\uC7AC \uD1B5\uC5ED", desc: "\uBD80\uB52A\uD78C \uB300\uD654 \uC804\uCCB4\uB97C \uBD84\uC11D", ex: "\uB2E4\uD230 \uB300\uD654\uB97C \uD1B5\uC9F8\uB85C \uC9DA\uC5B4\uBCF4\uACE0 \uC2F6\uC744 \uB54C", placeholder: "\uC8FC\uACE0\uBC1B\uC740 \uB300\uD654(\uCE74\uD1A1 \uB4F1)\uB97C \uD1B5\uC9F8\uB85C \uBD99\uC5EC\uB123\uC5B4 \uBCF4\uC138\uC694." },
  { key: "perspective", emoji: "\u{1F504}", title: "\uAD00\uC810 \uD1B5\uC5ED", desc: '"\uC0C1\uB300\uB294 \uC5B4\uB5BB\uAC8C \uB290\uAF08\uC744\uAE4C?"', ex: "\uC0C1\uB300 \uC785\uC7A5\uC774 \uB3C4\uBB34\uC9C0 \uC774\uD574 \uC548 \uB420 \uB54C", placeholder: "\uC5B4\uB5A4 \uC0AC\uAC74\uC774\uB098 \uB300\uD654\uB97C \uC801\uC5B4 \uBCF4\uC138\uC694. \uC0C1\uB300 \uC785\uC7A5\uC5D0\uC11C \uD1B5\uC5ED\uD574 \uB4DC\uB824\uC694." }
];
const FIELD = {
  surface: "\uD45C\uBA74\uC801\uC73C\uB85C\uB294",
  ...
  partner_view: "\uC0C1\uB300\uC758 \uB208\uC5D0\uB294",
  partner_feeling: "\uADF8\uB54C \uC0C1\uB300\uC758 \uAC10\uC815",
...
const ROOMS = [
  { key: "teen_parent", label: "\uC0AC\uCD98\uAE30 \uC790\uB140" },
  { key: "retire_dad", label: "\uC740\uD1F4\uD55C \uC544\uBC84\uC9C0" },
  { key: "holiday", label: "\uBA85\uC808" },
  { key: "caregiving", label: "\uAC04\uBCD1" },
  { key: "kangaroo", label: "\uD55C\uC9D1\uC0B4\uC774" }
];
...
function Onboarding({ onDone }) {
  ...
  return /* @__PURE__ */ React.createElement(Shell, { title: "\uC2DC\uC791\uD558\uAE30" }, step === 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 800, marginBottom: 6 } }, "\uC5B4\uB5A4 \uC5B8\uC5B4\uB85C \uD1B5\uC5ED\uD560\uAE4C\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 14, marginBottom: 16 } }, "\uB098\uC5D0\uAC8C \uB9DE\uB294 \uACBD\uB85C\uB97C \uACE0\uB974\uC138\uC694. \uC124\uC815\uC5D0\uC11C \uC5B8\uC81C\uB4E0 \uBC14\uAFC0 \uC218 \uC788\uC5B4\uC694."), /* @__PURE__ */ React.createElement(TrackCard, { v: "psychology", title: "\u{1F331} \uC2EC\uB9AC\uC0C1\uB2F4 \uD2B8\uB799", tag: "\uCC98\uC74C\uC774\uB77C\uBA74 \uCD94\uCC9C", desc: "\uC2E0\uC559\uACFC \uBB34\uAD00\uD558\uAC8C, \uAC80\uC99D\uB41C \uC2EC\uB9AC\uD559(\uC560\uCC29\xB7\uC815\uC11C)\uC73C\uB85C \uB9C8\uC74C\uC744 \uD480\uC5B4\uB4DC\uB824\uC694." }), /* @__PURE__ */ React.createElement(TrackCard, { v: "christian", title: "\u271D\uFE0F \uAE30\uB3C5\uAD50 \uD2B8\uB799", desc: "\uC2E0\uC559 \uC548\uC5D0\uC11C, \uC131\uACBD\uC801 \uAD00\uC810(\uACF5\uACBD\uACFC \uBD84\uB9AC\xB7\uD68C\uBCF5)\uC73C\uB85C \uD1B5\uC5ED\uD574\uC694. \uC2E0\uC559\uC744 \uAC00\uC9C4 \uAC00\uC871\uC5D0\uAC8C \uB9DE\uC544\uC694." }), /* @__PURE__ */ React.createElement("div", { style: { height: 12 } }), /* @__PURE__ */ React.createElement(Btn, { onClick: () => setStep(1) }, "\uB2E4\uC74C")), step === 1 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 800, marginBottom: 6 } }, "\uAC15\uB3C4\uB97C \uB9DE\uCDB0\uBCFC\uAE4C\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 14, marginBottom: 16 } }, "\uD3B8\uD55C \uB9CC\uD07C\uB9CC. \uC5B8\uC81C\uB4E0 \uC870\uC808\uB3FC\uC694."), track === "psychology" ? /* @__PURE__ */ React.createElement(
    Slider,
    {
      label: "\uAC10\uC815 \uAE4A\uC774",
...
function Home({ config, ageTier, relationId, picker, onMode, onMemory, onSettings }) {
  ...
  return /* @__PURE__ */ React.createElement(Shell, { right: /* @__PURE__ */ React.createElement("button", { onClick: () => setAsk(true), style: { background: "rgba(255,255,255,.18)", border: "none", color: "#fff", padding: "6px 10px", borderRadius: 9, cursor: "pointer", fontSize: 13 } }, "\u2699\uFE0F \uC124\uC815") }, picker, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: MUT, marginBottom: 4 } }, config.track === "christian" ? "\u271D\uFE0F \uAE30\uB3C5\uAD50 \uD2B8\uB799" : "\u{1F331} \uC2EC\uB9AC\uC0C1\uB2F4 \uD2B8\uB799"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 800, marginBottom: 4 } }, ageTier === "teen" ? "\uBB34\uC2A8 \uC77C\uC774 \uC788\uC5C8\uC5B4?" : "\uBB34\uC5C7\uC744 \uD1B5\uC5ED\uD574 \uB4DC\uB9B4\uAE4C\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 13, marginBottom: 16 } }, ageTier === "teen" ? "\uBB34\uC2A8 \uB9D0\uC744 \uB4E4\uC5C8\uB294\uC9C0 \uADF8\uB300\uB85C \uC801\uC5B4\uB3C4 \uAD1C\uCC2E\uC544. \uB124 \uC798\uBABB\uC778\uC9C0 \uC544\uB2CC\uC9C0\uBD80\uD130 \uAC19\uC774 \uBD10\uC904\uAC8C." : '\uC0C1\uD669\uC5D0 \uB9DE\uB294 \uAC78 \uACE0\uB974\uC138\uC694. \uC544\uB798 "\uC774\uB7F4 \uB54C"\uB97C \uCC38\uACE0\uD558\uBA74 \uC26C\uC6CC\uC694.'), !relationId && /* @__PURE__ */ React.createElement(Card, { style: { background: "#f6faf8", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, color: MUT, lineHeight: 1.7 } }, "\uBA3C\uC800 ", /* @__PURE__ */ React.createElement("b", { style: { color: INK } }, "\uB204\uAD6C\uC640\uC758 \uB300\uD654\uC778\uC9C0"), " \uC704\uC5D0\uC11C ", /* @__PURE__ */ React.createElement("b", { style: { color: INK } }, "+ \uCD94\uAC00"), "\uB85C \uB9CC\uB4E4\uC5B4 \uC8FC\uC138\uC694. \uC544\uBC84\uC9C0\xB7\uC5B4\uBA38\uB2C8\uB294 \uAC01\uAC01 \uB2E4\uB978 \uAD00\uACC4\uB85C \uB098\uB220\uC11C \uAE30\uC5B5\uD574\uC694.")), MODES.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.key, onClick: () => relationId && onMode(m), style: { opacity: relationId ? 1 : 0.45, cursor: relationId ? "pointer" : "not-allowed", border: `1px solid ${LINE}`, borderRadius: 16, padding: 16, marginBottom: 10, display: "flex", alignItems: "center", gap: 14, background: "#fff" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 30 } }, m.emoji), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 800, fontSize: 17 } }, m.title), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 13, marginTop: 2 } }, m.desc), /* @__PURE__ */ React.createElement("div", { style: { color: GREEN, fontSize: 12, marginTop: 4 } }, "\uC774\uB7F4 \uB54C \xB7 ", m.ex)), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 20 } }, "\u203A"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 10 } }, /* @__PURE__ */ React.createElement(Btn, { kind: "ghost", onClick: onMemory, disabled: !relationId }, "\u{1F9E0} \uC774 \uAD00\uACC4\uC758 \uAE30\uC5B5")), ask && /* @__PURE__ */ React.createElement(
    "div",
    {
...
function ModeView({ mode, config, relationId, ageTier, onBack }) {
  ...
  const run = async (ack) => {
    ...
    if (r.status === 429) {
      setErr(r.error || "\uC624\uB298\uC740 \uC5EC\uAE30\uAE4C\uC9C0 \uC774\uC57C\uAE30 \uB098\uB234\uC5B4\uC694. \uB0B4\uC77C \uB2E4\uC2DC \uB9CC\uB098\uC694.");
      return;
    }
    if (r.boundaryNotice) {
      setBoundary(r.result);
      return;
    }
    if (!r.ok || !r.result) {
  ...
  return /* @__PURE__ */ React.createElement(Shell, { title: `${mode.emoji} ${mode.title}`, onBack }, !result && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 14, marginBottom: 10 } }, mode.placeholder), ageTier !== "teen" && (mode.key === "receive" || mode.key === "perspective") && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: MUT, marginBottom: 5 } }, "\uC774 \uB9D0\uC744 \uC5B4\uB5BB\uAC8C \uC54C\uAC8C \uB418\uC168\uB098\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 7 } }, [["direct", "\uC800\uC5D0\uAC8C \uC9C1\uC811 \uD55C \uB9D0"], ["observed", "\uCE74\uD1A1\xB7\uC77C\uAE30 \uB4F1\uC744 \uBD24\uC5B4\uC694"]].map(([k, t]) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: k,
      onClick: () => {
      ...
      style: {
        ...
        cursor: "pointer",
        whiteSpace: "nowrap",
        border: "1px solid " + (src === k ? GREEN : LINE),
        background: src === k ? GREEN : "#fff",
        color: src === k ? "#fff" : INK,
        fontWeight: src === k ? 800 : 500
      }
    },
    t
...
function AgeCheck({ onPass }) {
  ...
  return /* @__PURE__ */ React.createElement(Shell, { title: "\u{1F33F} \uB9C8\uC74C\uC138\uB300" }, /* @__PURE__ */ React.createElement(Card, { style: { marginTop: 30 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 19, fontWeight: 800, marginBottom: 6 } }, "\uBA3C\uC800 \uB098\uC774\uB97C \uC54C\uB824\uC8FC\uC138\uC694"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 13.5, lineHeight: 1.7, marginBottom: 14 } }, "\uB098\uC774\uC5D0 \uB530\uB77C \uC548\uB0B4 \uBC29\uC2DD\uC774 \uB2EC\uB77C\uC838\uC694. \uCCAD\uC18C\uB144\uC5D0\uAC8C\uB294 \uCCAD\uC18C\uB144\uC5D0\uAC8C \uB9DE\uB294 \uBC29\uC2DD\uC73C\uB85C \uB3C4\uC640\uB4DC\uB824\uC694."), msg && /* @__PURE__ */ React.createElement("div", { style: { background: "#fff4ee", border: "1px solid #f5c6a5", color: "#b45309", borderRadius: 10, padding: "10px 13px", fontSize: 13.5, lineHeight: 1.7, marginBottom: 12 } }, msg), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "date",
      value: d,
  ...
  ), /* @__PURE__ */ React.createElement(Btn, { onClick: submit, disabled: !d || busy }, "\uD655\uC778"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 12, marginTop: 12, lineHeight: 1.7 } }, "\uC0DD\uB144\uC6D4\uC77C\uC740 \uB098\uC774 \uD655\uC778\uC5D0\uB9CC \uC4F0\uACE0, \uB2E4\uB978 \uACF3\uC5D0 \uBCF4\uC5EC\uC8FC\uC9C0 \uC54A\uC544\uC694.")));
}
function RelationPicker({ relations, current, onPick, onCreated, ageTier }) {
  ...
  const create = async () => {
    ...
    setBusy(true);
    setErr("");
    const r = await api("/relation", "POST", { ownerRole: role, counterpartLabel: label.trim(), counterpartContext: ctx.trim() || void 0 });
    setBusy(false);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: MUT, marginBottom: 6 } }, "\uB204\uAD6C\uC640\uC758 \uB300\uD654\uC778\uAC00\uC694?"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 7, flexWrap: "wrap", alignItems: "center" } }, relations.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, onClick: () => onPick(r.id), style: chip(r.id === current) }, r.counterpart_label)), /* @__PURE__ */ React.createElement("div", { onClick: () => setOpen(true), style: { ...chip(false), borderStyle: "dashed", color: GREEN } }, "+ \uCD94\uAC00")), open && /* @__PURE__ */ React.createElement(Card, { style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 800, marginBottom: 10 } }, "\uAD00\uACC4 \uCD94\uAC00"), err && /* @__PURE__ */ React.createElement("div", { style: { background: "#fff4ee", color: "#b45309", borderRadius: 8, padding: "8px 11px", fontSize: 13, marginBottom: 10 } }, err), ageTier !== "teen" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: MUT, marginBottom: 5 } }, "\uB098\uB294 \uC774 \uAD00\uACC4\uC5D0\uC11C"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 7, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { onClick: () => setRole("child"), style: chip(role === "child") }, "\uC790\uB140\uC608\uC694"), /* @__PURE__ */ React.createElement("div", { onClick: () => setRole("parent"), style: chip(role === "parent") }, "\uBD80\uBAA8\uC608\uC694"))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: MUT, marginBottom: 5 } }, "\uC0C1\uB300\uB97C \uBB50\uB77C\uACE0 \uBD80\uB974\uB098\uC694?"), /* @__PURE__ */ React.createElement(
    "input",
    {
      value: label,
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: MUT, marginBottom: 5 } }, "\uC0C1\uB300\uC5D0 \uB300\uD574 \uC54C\uB824\uC8FC\uC2E4 \uAC83 (\uC120\uD0DD)"), /* @__PURE__ */ React.createElement(
    "input",
    {
      value: ctx,
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement(Btn, { kind: "ghost", onClick: () => setOpen(false) }, "\uCDE8\uC18C"), /* @__PURE__ */ React.createElement(Btn, { onClick: create, disabled: !role || !label.trim() || busy }, "\uB9CC\uB4E4\uAE30"))));
}
function App() {
  ...
  if (!authed) return /* @__PURE__ */ React.createElement(Shell, null, /* @__PURE__ */ React.createElement(Card, { style: { textAlign: "center", marginTop: 40 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 40 } }, "\u{1F33F}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 800, margin: "10px 0" } }, "\uB9C8\uC74C\uC138\uB300"), /* @__PURE__ */ React.createElement("div", { style: { color: MUT, fontSize: 14, lineHeight: 1.7 } }, "\uB9C8\uC74C\uD480\uC5D0 \uB85C\uADF8\uC778\uD55C \uB4A4,", /* @__PURE__ */ React.createElement("br", null), "\uBA54\uB274\uC758 ", /* @__PURE__ */ React.createElement("b", null, "\u{1F33F} \uB9C8\uC74C\uC138\uB300"), "\uB85C \uB4E4\uC5B4\uC640 \uC8FC\uC138\uC694."), /* @__PURE__ */ React.createElement("div", { style: { height: 16 } }), /* @__PURE__ */ React.createElement(Btn, { onClick: () => window.open("https://maumful.com", "_blank") }, "\uB9C8\uC74C\uD480\uB85C \uAC00\uAE30")));
  if (!ageTier) return /* @__PURE__ */ React.createElement(AgeCheck, { onPass: async (t) => {
    setAgeTier(t);
    await loadRelations();
  } });
  if (!config) return /* @__PURE__ */ React.createElement(Onboarding, { onDone: () => setConfig(loadConfig()), ageTier });
  ...
  return /* @__PURE__ */ React.createElement(
    Home,
    {
      ...
      ageTier,
      relationId,
      picker: /* @__PURE__ */ React.createElement(
        RelationPicker,
        {
          relations,
          current: relationId,
          ageTier,
          onPick: setRelationId,
          onCreated: (id) => loadRelations(id)
        }
      ),
      onMode: (m) => {
        setMode(m);
